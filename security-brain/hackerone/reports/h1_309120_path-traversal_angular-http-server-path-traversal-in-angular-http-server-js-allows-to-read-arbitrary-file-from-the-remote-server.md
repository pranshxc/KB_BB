...
h1_id: '309120'
original_report_id: '309120'
title: '[angular-http-server] Path Traversal in angular-http-server.js allows to read
  arbitrary file from the remote server'
...
- HackerOne Report ID: 309120
- Weakness: Path Traversal
- Program: nodejs-ecosystem
- Disclosed At: 2018-03-01T22:14:10.111Z
- Has Bounty: No
- Visibility: full
- Substate: resolved
