...
h1_id: '677955'
original_report_id: '677955'
title: '`indexFile` option passed as an argument to node-server can lead to arbitrary
  file read'
...
- HackerOne Report ID: 677955
- Weakness: Path Traversal
- Program: nodejs-ecosystem
- Disclosed At: 2019-12-04T19:42:26.136Z
- Has Bounty: No
- Visibility: full
- Substate: informative
