...
h1_id: '217790'
original_report_id: '217790'
title: XSS in $shop$.myshopify.com/admin/ via twine template injection in "Shopify.API.Modal.input"
  method when using a malicious app
...
- HackerOne Report ID: 217790
- Weakness: Cross-site Scripting (XSS) - Generic
- Program: shopify
- Disclosed At: 2017-06-01T16:42:17.056Z
- Has Bounty: Yes
- Visibility: full
- Substate: resolved
