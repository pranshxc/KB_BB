...
h1_id: '309648'
original_report_id: '309648'
title: '[simplehttpserver] Stored XSS in file names leads to malicious JavaScript
  code execution when directory listing is output in HTML'
...
- HackerOne Report ID: 309648
- Weakness: Cross-site Scripting (XSS) - Stored
- Program: nodejs-ecosystem
- Disclosed At: 2018-02-26T21:44:29.711Z
- Has Bounty: No
- Visibility: full
- Substate: resolved
