...
h1_id: '90308'
original_report_id: '90308'
title: User email enumuration using Gmail
weakness: Information Disclosure
team_handle: coinbase
created_at: '2015-09-24T10:30:16.848Z'
disclosed_at: '2015-12-23T04:24:31.595Z'
has_bounty: true
visibility: full
substate: resolved
vote_count: 5
...
- HackerOne Report ID: 90308
- Weakness: Information Disclosure
- Program: coinbase
- Disclosed At: 2015-12-23T04:24:31.595Z
- Has Bounty: Yes
- Visibility: full
- Substate: resolved
...
while True:
        ...
        try:
                ...
                break 
```
That script will generate all the list of emails that can be created with *a-z+0-9*. this can easily be used with a dictionary bruteforce attack to generate more realistic emails like ██████████ (note: this is actually pretty much doable with a much powerful botnet who multi-thread this and give back the list of emails). 
