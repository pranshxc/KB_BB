...
h1_id: '730239'
original_report_id: '730239'
title: Filesystem Writes via `yarn install` via symlinks and tar transforms inside
  a crafted malicious package
...
- HackerOne Report ID: 730239
- Weakness: Path Traversal
- Program: nodejs-ecosystem
- Disclosed At: 2020-02-15T00:33:41.258Z
- Has Bounty: No
- Visibility: full
- Substate: resolved
