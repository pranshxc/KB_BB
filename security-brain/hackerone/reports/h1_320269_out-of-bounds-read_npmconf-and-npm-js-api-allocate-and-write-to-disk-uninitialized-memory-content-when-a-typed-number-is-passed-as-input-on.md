...
h1_id: '320269'
original_report_id: '320269'
title: '`npmconf` (and `npm` js api) allocate and write to disk uninitialized memory
  content when a typed number is passed as input on Node.js 4.x'
...
- HackerOne Report ID: 320269
- Weakness: Out-of-bounds Read
- Program: nodejs-ecosystem
- Disclosed At: 2018-05-12T08:56:12.533Z
- Has Bounty: No
- Visibility: full
- Substate: resolved
