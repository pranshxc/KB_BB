...
h1_id: '309641'
original_report_id: '309641'
title: '[simple-server] HTML with iframe element can be used as filename, which might
  lead to load and execute malicious JavaScript'
...
- HackerOne Report ID: 309641
- Weakness: Cross-site Scripting (XSS) - Stored
- Program: nodejs-ecosystem
- Disclosed At: 2018-03-01T23:04:03.545Z
- Has Bounty: No
- Visibility: full
- Substate: resolved
