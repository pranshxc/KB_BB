...
h1_id: '317125'
original_report_id: '317125'
title: '[bracket-template] Reflected XSS possible when variable passed via GET parameter
  is used in template'
...
- HackerOne Report ID: 317125
- Weakness: Cross-site Scripting (XSS) - Reflected
- Program: nodejs-ecosystem
- Disclosed At: 2018-04-09T14:58:19.748Z
- Has Bounty: No
- Visibility: full
- Substate: resolved
