...
h1_id: '331032'
original_report_id: '331032'
title: '[buttle] Remote Command Execution via unsanitized PHP filename when it''s
  run with --php-bin flag'
...
- HackerOne Report ID: 331032
- Weakness: OS Command Injection
- Program: nodejs-ecosystem
- Disclosed At: 2018-05-11T15:52:15.524Z
- Has Bounty: No
- Visibility: full
- Substate: resolved
