...
original_path: knowledge-inbox/blogs-incoming/2024-03-31_kobold-letters-why-html-emails-are-a-risk-to-your-organization.md
original_filename: 2024-03-31_kobold-letters-why-html-emails-are-a-risk-to-your-organization.md
...
- api-security
language: en
raw_sha256: 85bbae126d7340f15916eeb74a5f85035fa1a9364479135c0a3831a854222842
text_sha256: 49ec265fe40b40b21988962aad424ecea7f79662f6a359f3dbef2c4f5051d012
...
- Original Path: knowledge-inbox/blogs-incoming/2024-03-31_kobold-letters-why-html-emails-are-a-risk-to-your-organization.md
- Source Type: markdown
- Detected Topics: sso, command-injection, api-security
- Ingested At: 2026-06-28T07:32:32Z
- Redactions Applied: False
- Raw SHA256: `85bbae126d7340f15916eeb74a5f85035fa1a9364479135c0a3831a854222842`
- Text SHA256: `49ec265fe40b40b21988962aad424ecea7f79662f6a359f3dbef2c4f5051d012`
...
---
title: "Kobold Letters - Why HTML emails are a risk to your organization"
page_title: "Kobold letters – Lutra Security"
url: "https://lutrasecurity.com/en/articles/kobold-letters/"
final_url: "https://lutrasecurity.com/en/articles/kobold-letters/"
...
**TL;DR:** I gave a talk about Kobold Letters at BSides Munich 2024. You can [watch the recording on YouTube](https://www.youtube.com/watch?v=ko9cwRM3BZU).

* * *

![Kobold holding a letter by oira.art](./kobold_letter.png)
...
![A simple email containing the sentence "This text is always visible."](/en/articles/kobold-letters/kobold-moz-1.png)
...
![The sentence "This text will only appear after forwarding." is now visible.](/en/articles/kobold-letters/kobold-moz-2.png)
...
The report was marked as closed by Microsoft on 26.03.2024 after deciding not to take any immediate action.
...
![A simple email containing the sentence "This text is always visible."](/en/articles/kobold-letters/kobold-owa-1.png)
...
![The sentence "This text will only appear after forwarding." is now visible.](/en/articles/kobold-letters/kobold-owa-2.png)
...
Google confirmed on 09.04.2024 that they are working on a fix.
...
![A simple email containing the sentence "This text is always visible."](/en/articles/kobold-letters/kobold-gmail-1.png)
...
![The sentence "This text will only appear after forwarding." is now visible.](/en/articles/kobold-letters/kobold-gmail-2.png)
...
Users can mitigate kobold letters by disabling HTML email altogether or viewing it in a restricted mode (e.g. “plain HTML” in Thunderbird). For email clients, it is more difficult to implement a mitigation, as preventing the use of `<style>`1 would fix this, but would also break a lot of existing solutions in the email ecosystem. An implementation like the one Google already uses for Gmail could be a compromise that allows for stylized corporate newsletters while limiting the risks of HTML email.
...
![This is fine meme](/en/articles/kobold-letters/This-is-fine.jpg)

#### But I guess this is fine.

* * *

  1. <https://www.caniemail.com/features/html-style/> ↩︎
