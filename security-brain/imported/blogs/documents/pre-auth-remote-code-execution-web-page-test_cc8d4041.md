...
original_path: knowledge-inbox/blogs-incoming/2022-09-23_pre-auth-remote-code-execution-web-page-test.md
original_filename: 2022-09-23_pre-auth-remote-code-execution-web-page-test.md
...
- api-security
language: en
raw_sha256: cc8d404167452959548fb2285980a38e26804a93ad57855c8d1a45e0bb953915
text_sha256: 3bfd11d2bcd099b09f2470ff85fec6304122a2f801f6f98f553697ae3ea54229
...
- Original Path: knowledge-inbox/blogs-incoming/2022-09-23_pre-auth-remote-code-execution-web-page-test.md
- Source Type: markdown
- Detected Topics: command-injection, automation-abuse, ssrf, path-traversal, graphql, api-security
- Ingested At: 2026-06-28T07:32:14Z
- Redactions Applied: False
- Raw SHA256: `cc8d404167452959548fb2285980a38e26804a93ad57855c8d1a45e0bb953915`
- Text SHA256: `3bfd11d2bcd099b09f2470ff85fec6304122a2f801f6f98f553697ae3ea54229`
...
---
title: "Pre-Auth Remote Code Execution - Web Page Test"
page_title: "Pre-Auth Remote Code Execution - Web Page Test • Think
Love
Share"
url: "https://thinkloveshare.com/hacking/preauth_remote_code_execution_web_page_test/"
final_url: "https://thinkloveshare.com/hacking/preauth_remote_code_execution_web_page_test/"
...
__Sep 23, 2022 __17 min read __[Translate](https://thinkloveshare-com.translate.goog/?_x_tr_sl=en&_x_tr_tl=fr)  
...
A mirror of this article is also (_will soon be_) available on ManoMano’s Tech Blog on Medium!
...
![png-docker-build-fail](png-docker-build-fail.png)
...
![png-ssrf-curl](png-ssrf-curl.png)
...
![png-file-write-poc](png-file-write-poc.png)
...
![png-file-write](png-file-write.png)
...
But _maybe_ , with the _right sinks_ , if we have the _right gadgets_ and _autoload_ in place, we _might_ get somewhere with an unserialization attack with php’s `phar://` scheme.
...
![png-SaveTestInfo](png-SaveTestInfo.png)
...
![png-1001-ways](png-1001-ways.png)
...
And then, we start a new scan on _any_ website. The loop will use sed to modify the file in place.

![png-worker-up](png-worker-up.png) ![png-worker-down](png-worker-down.png)
...
![png-worker-rce](png-worker-rce.png)
...
[ __ RCE on Spip and Root-Me, v2! ](/hacking/rce_on_spip_and_root_me_v2/) [ Php-Internalog, Introspection Applied to 0day Research __](/hacking/php-internalog-introspection-for-0day-research/)
