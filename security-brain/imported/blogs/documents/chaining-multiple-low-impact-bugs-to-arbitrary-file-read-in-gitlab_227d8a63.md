...
original_path: knowledge-inbox/blogs-incoming/2019-06-04_chaining-multiple-low-impact-bugs-to-arbitrary-file-read-in-gitlab.md
original_filename: 2019-06-04_chaining-multiple-low-impact-bugs-to-arbitrary-file-read-in-gitlab.md
...
- cloud-security
language: en
raw_sha256: 227d8a63d77bafbffd2e95755be7e63ce06280524e111b24291375b133604743
text_sha256: b8179c9941992e29d2bb33d3f48a58bedae2fb14ded8477faba5cd828495f5f6
...
- Original Path: knowledge-inbox/blogs-incoming/2019-06-04_chaining-multiple-low-impact-bugs-to-arbitrary-file-read-in-gitlab.md
- Source Type: markdown
- Detected Topics: path-traversal, command-injection, api-security, cloud-security
- Ingested At: 2026-06-28T07:31:59Z
- Redactions Applied: False
- Raw SHA256: `227d8a63d77bafbffd2e95755be7e63ce06280524e111b24291375b133604743`
- Text SHA256: `b8179c9941992e29d2bb33d3f48a58bedae2fb14ded8477faba5cd828495f5f6`
...
---
title: "Chaining multiple low-impact bugs to arbitrary file read in GitLab"
page_title: "Chaining multiple low-impact bugs to arbitrary file read in GitLab - Nyangawa"
url: "https://blog.nyangawa.me/security/GitLab-Local-File-Read/"
final_url: "https://blog.nyangawa.me/security/GitLab-Local-File-Read/"
...
This interesting method is calling `File#read` which is a potential command execution vulnerability if the argument is controllable. (Mentioned in [this post](/security/CVE-2018-18649-Gitlab-RCE/)). Or even if it’s not fully controllable, the function could still be used to read local files.
...
Where `params[:name]` is controllable, then it’s passed to `GitignoreTemplate` then to `GlobalTemplateFinder` finally. I’m not going to paste too much code snippets here, anyone who is interested in the implementation can visit [the repository](https://gitlab.com/gitlab-org/gitlab-ce/tree/v11.5.2) for details.
...
They have disclosed [the issue](https://gitlab.com/gitlab-org/gitlab-ce/issues/54857) in their issue tracker after one month from the fix. I totally believe the value of transparency and [GitLab’s handbook](https://about.gitlab.com/handbook/values/#transparency) has a very clear description on transparency. I think it makes sense for the collaboration between the community of security researchers and the applications. OSS(open source softwares) give full transparency of their source code to the community so that the researchers could do much better on improving the quality of the applications than spending too much time to reconnoitering a black box and leaving those potentially critical deeply hidden security flaws undiscovered.

**__Categories:** [security](/categories/#security)

**__Updated:** June 4, 2019

[__Twitter](https://twitter.com/intent/tweet?text=Chaining+multiple+low-impact+bugs+to+arbitrary+file+read+in+GitLab%20https%3A%2F%2Fblog.nyangawa.me%2Fsecurity%2FGitLab-Local-File-Read%2F "Share on Twitter") [__Facebook](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fblog.nyangawa.me%2Fsecurity%2FGitLab-Local-File-Read%2F "Share on Facebook") [__LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fblog.nyangawa.me%2Fsecurity%2FGitLab-Local-File-Read%2F "Share on LinkedIn") [Previous](/security/CVE-2018-18649-Gitlab-RCE/ "Second bite on GitLab, and some interesting Ruby functions/features
") Next
