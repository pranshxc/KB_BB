...
original_path: knowledge-inbox/blogs-incoming/2022-04-19_adobe-acrobat-hollowing-out-same-origin-policy.md
original_filename: 2022-04-19_adobe-acrobat-hollowing-out-same-origin-policy.md
...
- access-control
language: en
raw_sha256: d90abb8ae876e274c5f32807def2c88079500937919ae6d7d5a897eb79ec4cc0
text_sha256: f74e55c1b1bca9b6ec8724a743be2cff755846dde3ead38ef4588080ee9efceb
...
- Original Path: knowledge-inbox/blogs-incoming/2022-04-19_adobe-acrobat-hollowing-out-same-origin-policy.md
- Source Type: markdown
- Detected Topics: xss, supply-chain, sso, jwt, idor, access-control
- Ingested At: 2026-06-28T07:32:11Z
- Redactions Applied: True
- Raw SHA256: `d90abb8ae876e274c5f32807def2c88079500937919ae6d7d5a897eb79ec4cc0`
- Text SHA256: `f74e55c1b1bca9b6ec8724a743be2cff755846dde3ead38ef4588080ee9efceb`
...
---
title: "Adobe Acrobat hollowing out same-origin policy"
page_title: "Adobe Acrobat hollowing out same-origin policy | Almost Secure"
url: "https://palant.info/2022/04/19/adobe-acrobat-hollowing-out-same-origin-policy/"
final_url: "https://palant.info/2022/04/19/adobe-acrobat-hollowing-out-same-origin-policy/"
...
2022-04-19 [Add-Ons](/categories/add-ons/)/[Security](/categories/security/) 17 mins [0 comments](/2022/04/19/adobe-acrobat-hollowing-out-same-origin-policy/#comments)
...
![A PDF file displayed in the browser. The address bar says: Adobe Acrobat. Adobe Acrobat icon is also visible in the browser’s toolbar.](/2022/04/19/adobe-acrobat-hollowing-out-same-origin-policy/acrobat.png)
...
The part waiting for `readyReceived` and `seenPdf` variables to be set is new. Now responses will be delayed until `documentcloud.adobe.com` frame loads _and_ the code deems the file to be a valid PDF. Note that the logic recognizing PDF files isn’t terribly reliable:
...
This _would_ have been an XSS vulnerability in the extension (very bad), but luckily the extension’s Content Security Policy stops this attack.
...
I got somewhat stuck, so I decided to check out what else is hosted on `documentcloud.adobe.com`. That’s when I discovered [this embed API demo](https://documentcloud.adobe.com/view-sdk-demo/index.html). And that suddenly made my job much easier:
  ...
  * This frame is _meant_ to be embedded by any website, so there is no framing protection.
  * The frame is in fact _meant_ to communicate with arbitrary websites, and it will accept all kinds of messages.
