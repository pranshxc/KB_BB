...
original_path: knowledge-inbox/blogs-incoming/2023-04-22_stealing-github-staffs-access-token-via-github-actions.md
original_filename: 2023-04-22_stealing-github-staffs-access-token-via-github-actions.md
...
- rate-limit
language: en
raw_sha256: e57acdc327acd7511edf49a2a1647b5e83c9578b52fe8b77f8b00afa79380c65
text_sha256: c9314920ac60a1acfe68fbc62fe202a11aa202a5652820821e73f32662aee559
...
- Original Path: knowledge-inbox/blogs-incoming/2023-04-22_stealing-github-staffs-access-token-via-github-actions.md
- Source Type: markdown
- Detected Topics: supply-chain, access-control, command-injection, otp, rate-limit
- Ingested At: 2026-06-28T07:32:20Z
- Redactions Applied: False
- Raw SHA256: `e57acdc327acd7511edf49a2a1647b5e83c9578b52fe8b77f8b00afa79380c65`
- Text SHA256: `c9314920ac60a1acfe68fbc62fe202a11aa202a5652820821e73f32662aee559`
...
---
title: "Stealing GitHub staff's access token via GitHub Actions"
page_title: "Stealing GitHub staff's access token via GitHub Actions - RyotaK's Blog"
url: "https://blog.ryotak.net/post/github-actions-staff-access-token-en/"
final_url: "https://blog.ryotak.net/post/github-actions-staff-access-token-en/"
...
## [Stealing GitHub staff's access token via GitHub Actions](https://blog.ryotak.net/post/github-actions-staff-access-token-en/)
 ...
 __2023-04-22 __1227 字 __[GitHub](/tags/github) [Vulnerability](/tags/vulnerability) [GitHub Actions](/tags/github-actions) [Supply Chain](/tags/supply-chain)
...
This trigger gets executed when an event related to a pull request occurs. While starting the workflow, it reads the definition file of the workflow from the forked repository1 and runs the workflow in the context of the base repository where the pull request was created, with a read-only token passed.  
This means a forked repository can execute arbitrary workflows on GitHub Actions in a public repository. 2
...
In [actions/runner](https://github.com/actions/runner), a workflow for E2E test called [e2etest.yml](https://github.com/actions/runner/blob/a9be5f65578a8225c6a024799f572ad2066c4fd8/.github/workflows/e2etest.yml) exist.3
...
So, I then checked the user profile and found that the user belongs to [@actions](https://github.com/actions) and [@github](https://github.com/github).  
As mentioned above, this token is used for multiple purposes, so it is assumed to have at least the `public_repo` scope.  
Therefore, by stealing this token, it is possible to obtain write permission for public repositories of [@actions](https://github.com/actions) and [@github](https://github.com/github).  
This could result in a serious supply chain issue because [@actions](https://github.com/actions) and [@github](https://github.com/github) own many repositories, including the official actions such as [actions/checkout](https://github.com/actions/checkout) and [actions/cache](https://github.com/actions/cache).

## Conclusion

In this article, I explained how a misconfiguration of GitHub Actions could lead to a serious supply chain risk.  
I hope this article helped you understand the importance of security in the CI/CD pipeline.

If you have any questions or comments, please feel free to contact me on Twitter ([@ryotkak](https://twitter.com/ryotkak)) or Misskey ([@[email protected]](https://misskey.io/@ryotak)).

## Timeline

Date (JST)| Event  
---|---  
2021/06/19| Vulnerability discovery/reporting  
2021/06/19| Temporary fix  
2021/06/22| Permanent fix  
2022/12/18| Start writing this article  
2023/04/11| Got permission to publish this article  
2023/04/22| Published this article  
  
* * *

  1. To be more specific, it uses the definition file of the workflow at the time of the merge commit of the pull request. ↩︎

  2. More precisely, due to [this change](https://github.blog/changelog/2021-04-22-github-actions-maintainers-must-approve-first-time-contributor-workflow-runs/), the workflow will not automatically run unless you have contributed to the target repository at least once. ↩︎

  3. I’m omitting the code as it’s over 300 lines, but you can see the workflow file here: <https://github.com/actions/runner/blob/a9be5f65578a8225c6a024799f572ad2066c4fd8/.github/workflows/e2etest.yml> ↩︎
