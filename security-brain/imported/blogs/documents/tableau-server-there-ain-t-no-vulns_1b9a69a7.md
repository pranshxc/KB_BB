...
original_path: knowledge-inbox/blogs-incoming/2024-02-19_tableau-server-there-aint-no-vulns.md
original_filename: 2024-02-19_tableau-server-there-aint-no-vulns.md
...
- api-security
language: en
raw_sha256: 1b9a69a781705e8a0d5bb0d3fd3dad5a9af15adaa949d33284c221fdfd18cb82
text_sha256: c76b1d3fa980ead2ae6ea27b8c4e7cbef4d8fa6defea742a43136a080b27c07f
...
- Original Path: knowledge-inbox/blogs-incoming/2024-02-19_tableau-server-there-aint-no-vulns.md
- Source Type: markdown
- Detected Topics: ssrf, sso, command-injection, path-traversal, otp, api-security
- Ingested At: 2026-06-28T07:32:31Z
- Redactions Applied: True
- Raw SHA256: `1b9a69a781705e8a0d5bb0d3fd3dad5a9af15adaa949d33284c221fdfd18cb82`
- Text SHA256: `c76b1d3fa980ead2ae6ea27b8c4e7cbef4d8fa6defea742a43136a080b27c07f`
...
---
title: "Tableau Server - There Ain't No Vulns"
page_title: "Tableau Server - There Ain’t No Vulns | Frycos Security Diary"
url: "https://frycos.github.io/vulns4free/2024/02/19/tableau-server-no-vulns.html"
final_url: "https://frycos.github.io/vulns4free/2024/02/19/tableau-server-no-vulns.html"
...
The `serverHost` variable is wrapped into a `java.net.URI` object and passed to `com.tableau.maestro.vizportal.clientXmlApi.util.ClientXmlApiClient#getVizportalDocumentVersion(java.net.URI)`. The method `com.tableau.maestro.vizportal.clientXmlApi.util.ClientXmlApiUrlBuilder#getServerAuthInfoRequestUrl` adds the path `/auth` and the corresponding query parameter `format=xml` to the URI. Again, following the call chain further
  ...
  -> com.tableau.maestro.vizportal.clientXmlApi.util.ClientXmlApiClient#***REDACTED-SUSPECT-TOKEN***  --> com.tableau.maestro.vizportal.clientXmlApi.util.ClientXmlApiClient#issueGetRequestForUrl
...
[](/vulns4free/2024/02/19/tableau-server-no-vulns.html)
