...
original_path: knowledge-inbox/blogs-incoming/2023-02-24_alternative-link.md
original_filename: 2023-02-24_alternative-link.md
...
- otp
language: en
raw_sha256: fd2366427903d4c5550717b5dcdbf0889275fbe66db7f0e12ae23aa1dd0b3e30
text_sha256: 212bcf31e55b133a2a9b8a18f36e3df8cc94186cb1b2f0aa07817773c34ab90d
...
- Original Path: knowledge-inbox/blogs-incoming/2023-02-24_alternative-link.md
- Source Type: markdown
- Detected Topics: xss, oauth, sso, idor, command-injection, otp
- Ingested At: 2026-06-28T07:32:18Z
- Redactions Applied: False
- Raw SHA256: `fd2366427903d4c5550717b5dcdbf0889275fbe66db7f0e12ae23aa1dd0b3e30`
- Text SHA256: `212bcf31e55b133a2a9b8a18f36e3df8cc94186cb1b2f0aa07817773c34ab90d`
...
---
title: "Alternative link"
page_title: "Microsoft Azure Account Takeover via DOM-based XSS in Cosmos DB Explorer · Creastery"
url: "https://www.creastery.com/blog/microsoft-azure-ato-via-xss-in-cosmos-db-explorer/"
final_url: "https://www.creastery.com/blog/microsoft-azure-ato-via-xss-in-cosmos-db-explorer/"
...
24 February 2023 __~9 minutes read  

  * [ web ](https://www.creastery.com/tags#web)
  * [ azure ](https://www.creastery.com/tags#azure)
  * [ bug-bounty ](https://www.creastery.com/tags#bug-bounty)
  * [ js ](https://www.creastery.com/tags#js)
  * [ xss ](https://www.creastery.com/tags#xss)

While performing research work on a completely unrelated target, I chanced upon the repository for [Microsoft Azure’s Cosmos DB Explorer](https://github.com/Azure/cosmos-explorer). With some time to spare, I decided to do a quick audit of the codebase. Skimming through the codebase, a silly, but rather common, bug caught my attention – forgetting to escape dots in regular expressions when checking if a message sender’s origin is to be trusted.

As the [Azure Cosmos DB Explorer](https://cosmos.azure.com) incorrectly accepts and processs cross-origin messages from certain domains, a remote attacker can take over a victim Azure user’s account by delivering a DOM-based XSS payload via a cross-origin message.
...
_**Note:** poc.zip is omitted for brevity._
...
#### Victim
  ...
  3. Observe that the OAuth tokens stored in `localStorage` are being displayed in an alert window: ![XSS on cosmos.azure.com](/assets/images/posts/2023-02-24-microsoft-azure-cosmos-db-explorer-xss-poc.png)
...
This suggested fix was accepted and used by Microsoft in [PR #1239](https://github.com/Azure/cosmos-explorer/pull/1239), which was committed into the codebase on 26th March 2022.
...
In this particular incident, a remote attacker can takeover a victim user’s Azure session and conduct post-exploitation to reach and compromise their cloud assets. All of this is possible because of a _**single, unescaped dot**_!
