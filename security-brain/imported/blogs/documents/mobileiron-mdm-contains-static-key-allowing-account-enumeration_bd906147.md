...
original_path: knowledge-inbox/blogs-incoming/2021-03-22_mobileiron-mdm-contains-static-key-allowing-account-enumeration.md
original_filename: 2021-03-22_mobileiron-mdm-contains-static-key-allowing-account-enumeration.md
...
- idor
language: en
raw_sha256: bd906147dea89450976c6493ec9ad8d7f059dc4fe57fce2163e03a9b9bf1b951
text_sha256: 926f70a4a11db59ee98d06d86211bbc9a6ff41c27cca631319676d4637e03cdb
...
- Original Path: knowledge-inbox/blogs-incoming/2021-03-22_mobileiron-mdm-contains-static-key-allowing-account-enumeration.md
- Source Type: markdown
- Detected Topics: mfa, mobile-security, rate-limit, api-security, sso, idor
- Ingested At: 2026-06-28T07:32:05Z
- Redactions Applied: True
- Raw SHA256: `bd906147dea89450976c6493ec9ad8d7f059dc4fe57fce2163e03a9b9bf1b951`
- Text SHA256: `926f70a4a11db59ee98d06d86211bbc9a6ff41c27cca631319676d4637e03cdb`
...
---
title: "MobileIron MDM Contains Static Key Allowing Account Enumeration"
page_title: "MobileIron MDM Contains Static Key Allowing Account Enumeration | Into the Abyss"
url: "https://emptynebuli.github.io/tooling/2021/03/22/rustyiron.html"
final_url: "https://emptynebuli.github.io/tooling/2021/03/22/rustyiron.html"
...
Mar 22, 2021 ~ Apr 18, 2024 

In December, 2020, I originally released this content through [Optiv SourceZero](https://www.optiv.com/insights/source-zero/blog/mobileiron-mdm-contains-static-key-allowing-account-enumeration). To ensure future control over this content and provide central storage, I have copied here.
...
The rough PoC of rustyIron has been replaced by [Dauthi](https://github.com/emptynebuli/dauthi) which is a MDM analysis framework designed to perform SFA validation against numerous platforms.
...
[![Figure 1: MobileIron Initial Registration UI](/assets/images/mobileiron_img1.png)](/assets/images/mobileiron_img1.png "Figure 1: MobileIron Initial Registration UI") **Figure 1: MobileIron Initial Registration UI**
...
Like VMWare’s Airwatch, submitting an email address will initiate a discovery process to identify the authentication endpoint attributed to the email address’ FQDN. This discovery process is triggered against a [MobileIron hosted API](https://appgw.mobileiron.com/). However, unlike Airwatch, MobileIron attempts to restrict access to only authorized requests through the implementation of an API key at the following URL:
  ...
  * <https://www.mobileiron.com/en>
  ...
  GET /api/v1/gateway/customers/servers?api-key=***REDACTED*** HTTP/1.1
...
[![Figure 3: MobileIron Discovery - Invalid API Key](/assets/images/mobileiron_img2.png)](/assets/images/mobileiron_img2.png "Figure 3: MobileIron Discovery - Invalid API Key") **Figure 3: MobileIron Discovery - Invalid API Key**
...
[![Figure 4: MobileIron Hardcoded API Key](/assets/images/mobileiron_img3.png)](/assets/images/mobileiron_img3.png "Figure 4: MobileIron Hardcoded API Key") **Figure 4: MobileIron Hardcoded API Key**
...
[![Figure 5: MobileIron Discovery - Valid API Key](/assets/images/mobileiron_img4.png)](/assets/images/mobileiron_img4.png "Figure 5: MobileIron Discovery - Valid API Key") **Figure 5: MobileIron Discovery - Valid API Key**
...
**_“The static key is used during the registration process and allows the mobile client to find a customer’s Core based on the user’s email address. Removing this functionally means the user would need to provide the host name of the Core which would likely be impactful on our customers’ workflow. The Engineering team is looking at additional options though there is currently no timeline for remediation.”_**
...
[![Figure 6: MobileIron Protocol Request - Packet Layout](/assets/images/mobileiron_img5.png)](/assets/images/mobileiron_img5.png "Figure 6: MobileIron Protocol Request - Packet Layout") **Figure 6: MobileIron Protocol Request - Packet Layout**
...
[![Figure 7: MIPR TCP Header- Hexdump](/assets/images/mobileiron_img6.png)](/assets/images/mobileiron_img6.png "Figure 7: MIPR TCP Header- Hexdump") **Figure 7: MIPR TCP Header- Hexdump**
...
[![Figure 9: MIPR 0x1D Response Packet](/assets/images/mobileiron_img7.png)](/assets/images/mobileiron_img7.png "Figure 9: MIPR 0x1D Response Packet") **Figure 9: MIPR 0x1D Response Packet**

The MIPR response is an `0x1D` message, containing the following ASCII content.
  
  
  inapp.reg.password=***REDACTED***
  inapp.reg.pin=true
  privacy.policy.client.isVisual=true
  vspCap=tlvV2;signedGUPSMGC
  mutualAuthEnabled=false
  inzerotouchknox_reg_pin=false
  inzerotouchknox_reg_password=***REDACTED***
  indeviceowner_reg_pin=false
  indeviceowner_reg_password=***REDACTED***
...
Each of these values are represented as masked ASCII HEX and do not directly reflect the plaintext input.
  ...
  platform_flags=0x143
  safety_net_enabled=true
  auth_username=***REDACTED-SUSPECT-TOKEN***  auth_password=***REDACTED***
  registration_operator_name=rustyIron
...
The masked value content was represented as a 16-byte or 128-bit ASCII HEX value. Hashing mechanisms, such as md5sum, output a fixed 128-bit hash, with sha1sum returning a 160-bit value. The unique characteristic of a hashing mechanism is that the output value is of a fixed length, regardless of the input content. Increasing the username from a 10 to 16 character value (`mobileiron123456`) resulted in the following output:
  ...
  auth_username=782DCCEF5AD512C360E05506***REDACTED-SUSPECT-TOKEN*****Figure 14: MIPR 0x1C Username Hash Value Length Increase**
...
[![Figure 15: Mobile@Work C4944v.java - Function m20994d](/assets/images/mobileiron_img8.png)](/assets/images/mobileiron_img8.png "Figure 15: Mobile@Work C4944v.java - Function m20994d") **Figure 15: Mobile@Work C4944v.java - Function m20994d**
...
[![Figure 16: Mobile@Work - RegisterActivity.java m20994d Function Call](/assets/images/mobileiron_img9.png)](/assets/images/mobileiron_img9.png "Figure 16: Mobile@Work - RegisterActivity.java m20994d Function Call") **Figure 16: Mobile@Work - RegisterActivity.java m20994d Function Call**
...
[![Figure 17: Mobile@Work - m33760C0 Assignment of r7, r8, and r9](/assets/images/mobileiron_img10.png)](/assets/images/mobileiron_img10.png "Figure 17: Mobile@Work - m33760C0 Assignment of r7, r8, and r9") **Figure 17: Mobile@Work - m33760C0 Assignment of r7, r8, and r9**

Through `m20857f()` of course!

[![Figure 18: Mobile@Work - m20857f\(\)](/assets/images/mobileiron_img11.png)](/assets/images/mobileiron_img11.png "Figure 18: Mobile@Work - m20857f\(\)") **Figure 18: Mobile@Work - m20857f()**
...
A successful authentication attempt is determined based on two criteria results. First, if a client is enabled in MobileIron and allowed to register a mobile device, MobileIron will respond with a zLib compressed payload containing the MobileIron MDM profile. This profile would contain a number of interesting details, including the associated `username`, `SenderGUID`, `UUID`, and `cookie` value. If an authentication is successful, the following `0x1D` response is received (`0X001D006400000193`).
  ...
  easV3Signature=bD7lFfthu0ZJHAvujEbRxIFrxP2m0K8***REDACTED-SUSPECT-TOKEN***  vnwWBECrbX030v8J4s2HXOPhZWF7kOIp3T0pPNKkfHVHLz***REDACTED-SUSPECT-TOKEN***  Nwufp6Y+W9HD+0yvacuxtWLpoKFC6ZwYjytN3dbsQkZvZMKcGCgspBir5R2CmnL/NVq06qlq5RPP5VSEx0HlIT
  ...
  easi=8CD275398038203DDA881B300286BBCCC30AAA608***REDACTED-SUSPECT-TOKEN***  F02F844
...
**Figure 19: MobileIron MDM Profile**
...
The lockout event is determined by the following `0x1D` response (`0X001D004C0000019300`). A full lockout MIPR message body will be formatted as follows:
  ...
  MIPR000200020000007000000000ffffffff000000***REDACTED-SUSPECT-TOKEN***  Locked: User has been locked out. Wait 26 seconds and try again
  

**Figure 20: MIPR Account Lockout Message**
...
[](/tooling/2021/03/22/rustyiron.html)
