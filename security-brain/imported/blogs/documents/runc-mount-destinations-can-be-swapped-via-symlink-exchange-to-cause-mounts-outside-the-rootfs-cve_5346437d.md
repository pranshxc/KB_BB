...
original_path: knowledge-inbox/blogs-incoming/2021-05-30_runc-mount-destinations-can-be-swapped-via-symlink-exchange-to-cause-mounts-outs.md
original_filename: 2021-05-30_runc-mount-destinations-can-be-swapped-via-symlink-exchange-to-cause-mounts-outs.md
title: runc mount destinations can be swapped via symlink-exchange to cause mounts
...
- supply-chain
language: en
raw_sha256: 5346437d80a769f0e5c025dcfa0a86d0a2acc225d91c2af51913674de96e65a4
text_sha256: 978a28db95a5fa996d645d95c7c36fb666e792c8e9c742168a557bbfedd64b10
...
- Original Path: knowledge-inbox/blogs-incoming/2021-05-30_runc-mount-destinations-can-be-swapped-via-symlink-exchange-to-cause-mounts-outs.md
- Source Type: markdown
- Detected Topics: race-condition, command-injection, api-security, supply-chain
- Ingested At: 2026-06-28T07:32:06Z
- Redactions Applied: False
- Raw SHA256: `5346437d80a769f0e5c025dcfa0a86d0a2acc225d91c2af51913674de96e65a4`
- Text SHA256: `978a28db95a5fa996d645d95c7c36fb666e792c8e9c742168a557bbfedd64b10`
...
page_title: "blog/runc-symlink-CVE-2021-30465 at main · champtar/blog · GitHub"
url: "https://github.com/champtar/blog/tree/main/runc-symlink-CVE-2021-30465"
final_url: "https://github.com/champtar/blog/tree/main/runc-symlink-CVE-2021-30465"
...
When mounting a volume, runc trusts the source, and will let the kernel follow symlinks, but it doesn't trust the target argument and will use 'filepath-securejoin' library to resolve any symlink and ensure the resolved target stays inside the container root. As explained in [SecureJoinVFS() documentation](https://github.com/cyphar/filepath-securejoin/blob/40f9fc27fba074f2e2eebb3f74456b4c4939f4da/join.go#L57-L60), using this function is only safe if you know that the checked file is not going to be replaced by a symlink, the problem is that we can replace it by a symlink. In K8S there is a trivial way to control the target, create a pod with multiple containers sharing some volumes, one with a correct image, and the other ones with non existing images so they don't start right away.
...
## Timeline
  ...
  * 2020-12-26: Initial report to [security@opencontainers.org](mailto:security@opencontainers.org) (Merry Christmas :) )
