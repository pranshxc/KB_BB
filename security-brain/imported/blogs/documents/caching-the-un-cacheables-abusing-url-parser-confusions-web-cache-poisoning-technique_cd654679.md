...
original_path: knowledge-inbox/blogs-incoming/2022-09-02_caching-the-un-cacheables-abusing-url-parser-confusions-web-cache-poisoning-tech.md
original_filename: 2022-09-02_caching-the-un-cacheables-abusing-url-parser-confusions-web-cache-poisoning-tech.md
title: Caching the Un-cacheables - Abusing URL Parser Confusions (Web Cache Poisoning
  Technique)
category: documents
detected_topics:
- xss
...
- api-security
language: en
raw_sha256: cd6546798c1b6cd19a2da7e03fc04a5983b055daec8298bf4bde7a58cffc56fe
text_sha256: 14e70a3f61837e02f29ee8d18b18d7a2b3b95a4fa6f99358f228f29a01d357ad
...
- Original Path: knowledge-inbox/blogs-incoming/2022-09-02_caching-the-un-cacheables-abusing-url-parser-confusions-web-cache-poisoning-tech.md
- Source Type: markdown
- Detected Topics: xss, command-injection, path-traversal, automation-abuse, api-security
- Ingested At: 2026-06-28T07:32:14Z
- Redactions Applied: False
- Raw SHA256: `cd6546798c1b6cd19a2da7e03fc04a5983b055daec8298bf4bde7a58cffc56fe`
- Text SHA256: `14e70a3f61837e02f29ee8d18b18d7a2b3b95a4fa6f99358f228f29a01d357ad`
...
page_title: "Caching the Un-cacheables - Abusing URL Parser Confusions (Web Cache Poisoning Technique) | Harel Security Research"
url: "https://nokline.github.io/bugbounty/2022/09/02/Glassdoor-Cache-Poisoning.html"
final_url: "https://nokline.github.io/bugbounty/2022/09/02/Glassdoor-Cache-Poisoning.html"
authors: ["Harel (@h4r3l)"]
programs: ["Glassdoor"]
...
## My XSS methodology
  ...
  * A common mistake I see people make when trying to bypass WAFs, or just filters in general for the matter, is they copy and paste generic WAF bypass payloads without actually understanding _why_ the WAF is blocking their requests. Spraying and praying WAFs is usually a waste of time from my experience, so it’s best to test them manually, and most importantly understand them
...
## Chaining the exploit
  ...
  * I found that every page under the Job path was vulnerable to self XSS, which was great! I took it a step further, and noticed that even pages that were _supposed_ to be 404s, actually returned 200 and were too vulnerable to the self XSS.
  ...
  * The attack surface of these two bugs were not “static”, but relied on a very relaxed wildcard pattern, which got me thinking: “Will these patterns _really_ accept anything? Will the server prioritize the pattern over special URL syntax, such as a dot segment `/../`, or will it normalize the URL and _then_ match the pattern?”
...
[](/bugbounty/2022/09/02/Glassdoor-Cache-Poisoning.html)
