...
original_path: knowledge-inbox/blogs-incoming/2023-05-17_alternative-link.md
original_filename: 2023-05-17_alternative-link.md
...
- api-security
language: en
raw_sha256: fdf012e21e4866d1b5c572ab8594f3dd87e71fd9bdbc97c91da85e1ec88c24fa
text_sha256: 0d51e8d5996e41b50eda6b1db43c86eb290660401e34ee7ed3fa6a35fcd3c4f8
...
- Original Path: knowledge-inbox/blogs-incoming/2023-05-17_alternative-link.md
- Source Type: markdown
- Detected Topics: xss, command-injection, csrf, api-security
- Ingested At: 2026-06-28T07:32:21Z
- Redactions Applied: False
- Raw SHA256: `fdf012e21e4866d1b5c572ab8594f3dd87e71fd9bdbc97c91da85e1ec88c24fa`
- Text SHA256: `0d51e8d5996e41b50eda6b1db43c86eb290660401e34ee7ed3fa6a35fcd3c4f8`
...
---
title: "Alternative link"
page_title: "DOS via cache poisoning on Mozilla - zhero_web_security"
url: "https://zhero-web-sec.github.io/dos-via-cache-poisoning/"
final_url: "https://zhero-web-sec.github.io/dos-via-cache-poisoning/"
...
![](/images/cpdos-2.png) _Illustration from Portswigger_
...
In order to exploit the behavior of the cache as an attacker it is necessary to understand how it works. I said earlier: “ _the cache provides an identical response to users who made a similar request_ ”, but how does the cache define that it is a similar request?
...
![](/images/cpdos-3.png)
  ...
  * **Second important element** : the `Age` header, **indicating the number of seconds since the cached** (storage) of the response/resource that was served to us. This header is sometimes accompanied by the `Cache-Control` header containing the caching directives, an important directive for us — _missing in the above response_ — is `max-age` **indicating the time limit in seconds for storing the resource.** The information transmitted by these two headers is particularly useful for an attacker to **know exactly when to send his malicious request** so that it is cached.
...
Then the cache — _when comparing the cache keys_ (content-negociation phase) — **will not find an identical version and will forward the request to the server** (the URL/request line being part of the cache key).
...
I start by doing small tests **to find interesting headers being “unkeyed”** (_not part of the cache key_) like `X-Forwarded-For`, `X-Host`, `X-Forwarded-Scheme` .. etc but nothing conclusive.
...
Here - _on this second CP_ \- the Mozilla security team decided that the report was not eligible for a bounty because the mention denial of service was specified in their OOS section. I’m used to reporting DOS via cache poisoning to companies marked DOS out of scope, but it’s accepted 90% of the time. My understanding of this is that they specify DOS in their OOS sections for obvious reasons, to prevent researchers from torpedoing them with requests in order to bring down the server which would be completely counterproductive.
...
**Check the disclosed report here** : <https://hackerone.com/reports/1976449>

**__Tags:** [cache](https://zhero-web-sec.github.io/tags/#cache),  [dos](https://zhero-web-sec.github.io/tags/#dos)

#### Share on

[ __Twitter](https://twitter.com/intent/tweet?text=https://zhero-web-sec.github.io/dos-via-cache-poisoning/ "Share on Twitter") [__Facebook](https://www.facebook.com/sharer/sharer.php?u=https://zhero-web-sec.github.io/dos-via-cache-poisoning/ "Share on Facebook") [__LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://zhero-web-sec.github.io/dos-via-cache-poisoning/ "Share on LinkedIn") Previous [Next](https://zhero-web-sec.github.io/xss-intigriti-challenge-0523/ "XSS Intigriti challenge 0523 ")
