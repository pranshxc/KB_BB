...
original_path: knowledge-inbox/blogs-incoming/2022-11-10_accidental-70k-google-pixel-lock-screen-bypass.md
original_filename: 2022-11-10_accidental-70k-google-pixel-lock-screen-bypass.md
...
- supply-chain
language: en
raw_sha256: 3816116c865f0126328a7db4679c9c745c01f86db2df703ba2fcb6a757cbc634
text_sha256: 583e59c70e0b27948b9400ac7ce57f0150ba8f462d213ef5d75094f8797fce17
...
- Original Path: knowledge-inbox/blogs-incoming/2022-11-10_accidental-70k-google-pixel-lock-screen-bypass.md
- Source Type: markdown
- Detected Topics: command-injection, race-condition, mobile-security, supply-chain
- Ingested At: 2026-06-28T07:32:15Z
- Redactions Applied: False
- Raw SHA256: `3816116c865f0126328a7db4679c9c745c01f86db2df703ba2fcb6a757cbc634`
- Text SHA256: `583e59c70e0b27948b9400ac7ce57f0150ba8f462d213ef5d75094f8797fce17`
...
---
title: "Accidental $70k Google Pixel Lock Screen Bypass"
page_title: "Accidental $70k Google Pixel Lock Screen Bypass - bugs.xdavidhu.me"
url: "https://bugs.xdavidhu.me/google/2022/11/10/accidental-70k-google-pixel-lock-screen-bypass/"
final_url: "https://bugs.xdavidhu.me/google/2022/11/10/accidental-70k-google-pixel-lock-screen-bypass/"
...
The issue allowed an attacker with physical access to bypass the lock screen protections (fingerprint, PIN, etc.) and gain complete access to the user’s device. The vulnerability is tracked as [CVE-2022-20465](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-20465) and it _might_ affect other Android vendors as well. You can find my patch advisory and the raw bug report I have sent to Google at [feed.bugs.xdavidhu.me](https://feed.bugs.xdavidhu.me/bugs/0016).
...
As I did before, I entered the PUK code and choose a new PIN. This time the phone glitched, and I was on my personal home screen. _What? It was locked before, right?_

This was disturbingly weird. I did it again. Lock the phone, re-insert the SIM tray, reset the PIN… And again I am on the home screen. _WHAT?_

My hands started to shake at this point. _WHAT THE F**K? IT UNLOCKED ITSELF?_
...
![Me in the London Google office a day after I cut my finger](/assets/posts/2022-11-10-accidental-70k-google-pixel-lock-screen-bypass/in-the-office.jpg) _me the day after cutting my finger_
...
![Screenshot of the commit message](/assets/posts/2022-11-10-accidental-70k-google-pixel-lock-screen-bypass/fix-commit.png)
...
![Screenshot of the commit's changed files section](/assets/posts/2022-11-10-accidental-70k-google-pixel-lock-screen-bypass/fix-commit-files.png)
...
Since the `.dismiss()` function simply dismissed the current security screen, it was vulnerable to _race conditions_. Imagine what would have happened if something in the background would have changed the current security screen before the PUK resetting component got to the `.dismiss()` call? Would the PUK component dismiss an unrelated security screen when it finally calls `.dismiss()`?
