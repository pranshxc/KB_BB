...
original_path: knowledge-inbox/blogs-incoming/2020-09-29_rce-on-spip-and-root-me.md
original_filename: 2020-09-29_rce-on-spip-and-root-me.md
...
- access-control
language: en
raw_sha256: 10a041bf2f4855536160164d574fc945dfaba8b2f8e0e39ea1c7dc9323f3e7b4
text_sha256: eece7e7098461a307f08a46af605ec7348774c9e5119a9cb9efe15ea57d7bad0
...
- Original Path: knowledge-inbox/blogs-incoming/2020-09-29_rce-on-spip-and-root-me.md
- Source Type: markdown
- Detected Topics: sqli, command-injection, path-traversal, supply-chain, sso, access-control
- Ingested At: 2026-06-28T07:32:03Z
- Redactions Applied: True
- Raw SHA256: `10a041bf2f4855536160164d574fc945dfaba8b2f8e0e39ea1c7dc9323f3e7b4`
- Text SHA256: `eece7e7098461a307f08a46af605ec7348774c9e5119a9cb9efe15ea57d7bad0`
...
---
title: "RCE on Spip and Root-Me"
page_title: "RCE on Spip and Root-Me • Think
Love
Share"
url: "https://thinkloveshare.com/hacking/rce_on_spip_and_root_me/"
final_url: "https://thinkloveshare.com/hacking/rce_on_spip_and_root_me/"
...
__Sep 29, 2020 __15 min read __[Translate](https://thinkloveshare-com.translate.goog/?_x_tr_sl=en&_x_tr_tl=fr)  
...
>  This article and research has no link with this incident **whatsoever**.
> 
...
![xss_size_input](xss_size_input.jpg)
...
![phpinfo_session](phpinfo_session.jpg)
...
![reflected_file_download](reflected_file_download.jpg)
...
![open_redirect_rootme](open_redirect_rootme.jpg)
...
![sqli_lier_trad](sqli_lier_trad.jpg)
...
![sqli_lier_trad_poc](sqli_lier_trad_poc.jpg)
...
![xss_var_profile_ie](xss_var_profile_ie.jpg)
...
I know this is wayyy too small, text version below.. ![stacktrace](stacktrace.jpg)
  ...
  3. Echo out the evaluated content to craft our payload  
...
![reflected_oups](reflected_oups.jpg) ![eval_debug](eval_debug.jpg)

  4. Spawn a phpinfo to see what is allowed / forbidden ![phpinfo](phpinfo.jpg)

  5. Bypass the php disable_functions policies with `popen` which wasn’t restricted // Edit, I probably just forgot to echo the result of shell_exec.. :)
...
![cmd_id](cmd_id.jpg)
  ...
  6. Profit?! ![cmd_uname](cmd_uname.jpg)

> Honestly, I never thought I would one day pwn root-me, but hey, here we are, and I’m so frikkin’ happy! :D ![happy_owl](happy_owl.jpg)

# Is root-me more secure than spip itself?

## XSS wise

The `parano` mode was enabled, which reduces the attack surface for XSS and escapes pretty much everything. Only a few were working on root-me. More information about this mode here: <https://www.spip.net/en_article4948.html>
...
![xss_null_rootme](xss_null_rootme.jpg)
...
[ __ A Helping Hand ](/hacking/a_helping_hand/) [ SSRF to RCE with Jolokia and MBeans __](/hacking/ssrf_to_rce_with_jolokia_and_mbeans/)
