...
original_path: knowledge-inbox/blogs-incoming/2021-04-04_remote-code-execution-through-unsafe-unserialize-in-php.md
original_filename: 2021-04-04_remote-code-execution-through-unsafe-unserialize-in-php.md
...
- supply-chain
language: en
raw_sha256: 4d5acfd3e189a98c5d18969f8d52156b752ee58ca5688c8402538c75481a10af
text_sha256: 7555687912421bc9e541b1ec3b4c68fe1ce26e7afdba9a6b8edbfa8539a82938
...
- Original Path: knowledge-inbox/blogs-incoming/2021-04-04_remote-code-execution-through-unsafe-unserialize-in-php.md
- Source Type: markdown
- Detected Topics: command-injection, automation-abuse, business-logic, supply-chain
- Ingested At: 2026-06-28T07:32:05Z
- Redactions Applied: False
- Raw SHA256: `4d5acfd3e189a98c5d18969f8d52156b752ee58ca5688c8402538c75481a10af`
- Text SHA256: `7555687912421bc9e541b1ec3b4c68fe1ce26e7afdba9a6b8edbfa8539a82938`
...
final_url: "https://www.sjoerdlangkemper.nl/2021/04/04/remote-code-execution-through-unsafe-unserialize/"
...
If a web application unserializes user input, there are two ways this can be vulnerable. First, the `unserialize` function is pretty complex. It has functionality to create any type of PHP object, bypassing the normal logic for this. It can handle reference loops and resource allocation. This is hard to do correctly when faced with untrusted input, and thus `unserialize` [is](https://bugs.php.net/bug.php?id=68942) [particularly](https://bugs.php.net/bug.php?id=68594) [prone](https://bugs.php.net/bug.php?id=68710) [to](https://bugs.php.net/bug.php?id=68710) [security](https://bugs.php.net/bug.php?id=74111) [bugs](https://bugs.php.net/bug.php?id=74103). These typically crash the PHP process, and may result in remote code execution for an attacker who’s really good with buffer overflows and bypassing [ASLR](https://en.wikipedia.org/wiki/Address_space_layout_randomization).
...
Such a useful piece of code is called a _gadget_. Sometimes, the destructor does not do directly what we want, but we have to combine a few pieces to get what we want. Combining multiple pieces of code in this way is called a _gadget chain_.
...
![A user control on the ebooks website shows two previously viewed books.](/images/recentlyviewedbooks.png)
...
![Burp Collaborator activity shows that the URL was retrieved.](/images/collaborator.png)
