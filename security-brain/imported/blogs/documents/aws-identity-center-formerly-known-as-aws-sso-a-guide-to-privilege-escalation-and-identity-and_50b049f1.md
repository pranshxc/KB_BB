...
original_path: knowledge-inbox/blogs-incoming/2023-05-01_aws-identity-center-formerly-known-as-aws-sso-a-guide-to-privilege-escalation-an.md
original_filename: 2023-05-01_aws-identity-center-formerly-known-as-aws-sso-a-guide-to-privilege-escalation-an.md
title: 'AWS Identity Center (formerly known as AWS SSO): A Guide to Privilege Escalation
...
- mfa
language: en
raw_sha256: 50b049f1a8275ed5b4daf911a6bdb584c38ab949c8ce2c96a639782cf8c6f5da
text_sha256: d4dfaa62e510a1ac26dc8247e896e8763edc83346b4546c0c9aa9d3cc62a73e9
...
- Original Path: knowledge-inbox/blogs-incoming/2023-05-01_aws-identity-center-formerly-known-as-aws-sso-a-guide-to-privilege-escalation-an.md
- Source Type: markdown
- Detected Topics: sso, access-control, cloud-security, saml, command-injection, mfa
- Ingested At: 2026-06-28T07:32:20Z
- Redactions Applied: False
- Raw SHA256: `50b049f1a8275ed5b4daf911a6bdb584c38ab949c8ce2c96a639782cf8c6f5da`
- Text SHA256: `d4dfaa62e510a1ac26dc8247e896e8763edc83346b4546c0c9aa9d3cc62a73e9`
...
page_title: "AWS Identity Center: Privilege Escalation | CloudQuery Blog"
url: "https://www.cloudquery.io/blog/aws-priv-esc-identity-center"
final_url: "https://www.cloudquery.io/blog/aws-priv-esc-identity-center"
authors: ["Jason Kao"]
programs: ["AWS"]
...
![Jason Kao](/images/people/jason.webp)

[Jason Kao](/authors/jason-kao)
...
Identity Center must be run from either the Organizational management account or a delegated administrator account. For more information about delegated administrator accounts, see [our blog post and research on delegated administrator](https://www.cloudquery.io/blog/guide-aws-org-delegation). If you're setting up Identity Center for the first time with Google Workspace as your identity provider, see our [step-by-step Google Workspace IdP setup guide](/blog/aws-sso-tutorial-with-google-workspace-as-an-idp).
...
![Dual Authorization Table Provided by AWS](/_next/image?url=https%3A%2F%2Fwww.cloudquery.io%2Fimages%2Fblog%2Faws-priv-esc-identity-center%2Fdualauth.webp&w=3840&q=75)
...
We recently added support for [CloudTrail Events](https://www.cloudquery.io/hub/plugins/source/cloudquery/aws/tables/aws_cloudtrail_events) and [Incremental Tables](https://www.cloudquery.io/docs/cli/advanced/managing-incremental-tables) with CloudQuery as we saw useful use cases for syncing CloudTrail events to the destination of your choice.

### CloudQuery Setup and Configuration #

To get setup, I have CloudQuery configured to sync from AWS to PostgreSQL.

For more detailed instructions on how to configure CloudQuery to sync from AWS to PostgreSQL, please follow our guide [here](https://www.cloudquery.io/hub/export-data/aws/postgresql).
...
Want to see CloudQuery in action? [Schedule a demo with our team](/contact-us) or check out the [platform documentation](https://www.cloudquery.io/docs/platform/introduction) to learn more.
...
[CloudQuery: AWS integration](https://www.cloudquery.io/hub/plugins/source/cloudquery/aws)

[AWS: What is IAM Identity Center](https://docs.aws.amazon.com/singlesignon/latest/userguide/what-is.html)

[![Jason Kao](/_next/image?url=%2Fimages%2Fpeople%2Fjason.webp&w=256&q=75)](/authors/jason-kao)

## Written by [Jason Kao](/authors/jason-kao)
...
[](https://www.linkedin.com/in/kaojason/ "LinkedIn Profile")
