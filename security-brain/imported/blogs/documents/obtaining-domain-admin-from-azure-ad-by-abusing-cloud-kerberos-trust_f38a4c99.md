...
original_path: knowledge-inbox/blogs-incoming/2023-06-13_obtaining-domain-admin-from-azure-ad-by-abusing-cloud-kerberos-trust.md
original_filename: 2023-06-13_obtaining-domain-admin-from-azure-ad-by-abusing-cloud-kerberos-trust.md
...
- otp
language: en
raw_sha256: f38a4c990d45e0a53add9fb99293d45541ef8c505c9c7d2c1046b4a0fe2c9575
text_sha256: c0bc1adf83d02f76cee9b07f6f9b73c7ed1fe4974d228c2093e1a74af312ee0f
...
- Original Path: knowledge-inbox/blogs-incoming/2023-06-13_obtaining-domain-admin-from-azure-ad-by-abusing-cloud-kerberos-trust.md
- Source Type: markdown
- Detected Topics: sso, jwt, access-control, command-injection, mfa, otp
- Ingested At: 2026-06-28T07:32:22Z
- Redactions Applied: False
- Raw SHA256: `f38a4c990d45e0a53add9fb99293d45541ef8c505c9c7d2c1046b4a0fe2c9575`
- Text SHA256: `c0bc1adf83d02f76cee9b07f6f9b73c7ed1fe4974d228c2093e1a74af312ee0f`
...
---
title: "Obtaining Domain Admin from Azure AD by abusing Cloud Kerberos Trust"
page_title: "Obtaining Domain Admin from Azure AD by abusing Cloud Kerberos Trust - dirkjanm.io"
url: "https://dirkjanm.io/obtaining-domain-admin-from-azure-ad-via-cloud-kerberos-trust/"
final_url: "https://dirkjanm.io/obtaining-domain-admin-from-azure-ad-via-cloud-kerberos-trust/"
...
![Password Replication allowed and denied group list](/assets/img/cloudkerberos/rodcaccount.png)
...
![TGT in PRT request](/assets/img/cloudkerberos/tgt_req.png)
...
![TGT in PRT response](/assets/img/cloudkerberos/tgt_resp.png)
...
![TGS-REQ exchanging the partial TGT for a full TGT](/assets/img/cloudkerberos/tgsreq.png)
...
![TGS-REP containing the plain NT hash](/assets/img/cloudkerberos/tgsrep.png)
...
![PRT for hybrid account](/assets/img/cloudkerberos/hybridprt.png)
...
![Upgrade the TGT](/assets/img/cloudkerberos/loadticket_upgrade.png)
...
![Upgrade the TGT with NT hash recovery](/assets/img/cloudkerberos/partialtofulltgt.png)
...
![Attributes of the hybrid account relevant for the on-premises sync](/assets/img/cloudkerberos/on_prem_attributes.png)
...
![Sync account update via provisioning API](/assets/img/cloudkerberos/provisioning.png)
...
![Provisioning data in XML format](/assets/img/cloudkerberos/provisioning_xml.png)
...
![Sync account update via provisioning API](/assets/img/cloudkerberos/newpac.png)
...
![Replication privileges on domain object for MSOL account](/assets/img/cloudkerberos/replprivs.png)
...
![Obtaining an access token for the sync api](/assets/img/cloudkerberos/roadtx_auth.png)
...
![Modifying the user SID and SAM](/assets/img/cloudkerberos/modifycmd.png)

We can confirm in the Azure Portal that the users properties have been changed:

![New properties in the Azure Portal](/assets/img/cloudkerberos/syncchange.png)
...
![Requesting a new PRT](/assets/img/cloudkerberos/newprtrequest.png)

With the partial TGT we can request the full TGT and recover the NT hash, this time for the MSOL account:

![Modifying the user SID and SAM](/assets/img/cloudkerberos/msolntrecovery.png)
...
![Performing DCSync with the MSOL account](/assets/img/cloudkerberos/dcsync.png)
...
![Preventing abuse of the MSOL account](/assets/img/cloudkerberos/aadkerberos_denymsol.png)
...
![Audit log showing only the modified timestamp](/assets/img/cloudkerberos/syncaudit.png)
...
**__Updated:** June 13, 2023

[__Twitter](https://twitter.com/intent/tweet?text=Obtaining+Domain+Admin+from+Azure+AD+by+abusing+Cloud+Kerberos+Trust%20https%3A%2F%2Fdirkjanm.io%2Fobtaining-domain-admin-from-azure-ad-via-cloud-kerberos-trust%2F "Share on Twitter") [__Facebook](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdirkjanm.io%2Fobtaining-domain-admin-from-azure-ad-via-cloud-kerberos-trust%2F "Share on Facebook") [__Google+](https://plus.google.com/share?url=https%3A%2F%2Fdirkjanm.io%2Fobtaining-domain-admin-from-azure-ad-via-cloud-kerberos-trust%2F "Share on Google Plus") [__LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fdirkjanm.io%2Fobtaining-domain-admin-from-azure-ad-via-cloud-kerberos-trust%2F "Share on LinkedIn") [Previous](/introducing-roadtools-token-exchange-roadtx/ "Introducing ROADtools Token eXchange \(roadtx\) - Automating Azure AD authentication, Primary Refresh Token \(ab\)use and device registration
") [Next](/phishing-for-microsoft-entra-primary-refresh-tokens/ "Phishing for Primary Refresh Tokens and Windows Hello keys
")
