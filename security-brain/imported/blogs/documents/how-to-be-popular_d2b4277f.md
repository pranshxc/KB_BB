...
original_path: knowledge-inbox/blogs-incoming/2021-08-02_how-to-be-popular.md
original_filename: 2021-08-02_how-to-be-popular.md
...
- api-security
language: en
raw_sha256: d2b4277fcbffee3fb784cf0de02f5d888797934430f4b6aa71da215af51c7b76
text_sha256: 98363167ba97c02b6ee71701ccb702740969930bf9d3867e1eb25a66840ed3f0
...
- Original Path: knowledge-inbox/blogs-incoming/2021-08-02_how-to-be-popular.md
- Source Type: markdown
- Detected Topics: cors, command-injection, otp, csrf, api-security
- Ingested At: 2026-06-28T07:32:07Z
- Redactions Applied: False
- Raw SHA256: `d2b4277fcbffee3fb784cf0de02f5d888797934430f4b6aa71da215af51c7b76`
- Text SHA256: `98363167ba97c02b6ee71701ccb702740969930bf9d3867e1eb25a66840ed3f0`
...
---
title: "how to be popular"
page_title: "how to be popular · discrete blogarithm"
url: "https://blog.azuki.vip/csrf/"
final_url: "https://blog.azuki.vip/csrf/"
authors: ["yan (@bcrypt)"]
programs: ["OkCupid"]
...
[Home](https://blog.azuki.vip/) [Posts](https://blog.azuki.vip/post) [About](https://blog.azuki.vip/about/)

© 2022. All rights reserved.

###  [discrete blogarithm](https://blog.azuki.vip/ "Home")
...
![attempt1](https://user-images.githubusercontent.com/549654/127945076-e050e29b-b620-414f-b470-367a08824e4a.png)
...
![attempt2](https://user-images.githubusercontent.com/549654/127944894-831c314c-590c-47a8-93a5-b80aa03ce663.png)
...
**UPDATE:** Multiple folks have kindly pointed out that setting the `SameSite` [cookie attribute](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Set-Cookie/SameSite) in modern browsers to `Strict` effectively prevents this attack and most other CSRFs. The behavior with `SameSite=Lax` is somewhat confusing; because submitting an HTML form triggers navigation, initially I assumed cross-origin cookies would be sent in this case. However, with the help of [Simon Willison](https://twitter.com/simonw/status/1422356089023078419), I found that this is actually not the case if `Lax` is explicitly set. But here’s the surprise: if a `SameSite` attribute is NOT explicitly set, then Chrome will send the cross-origin cookie in POST requests [that occur within 2 minutes](https://twitter.com/bcrypt/status/1422370774896177154) of when the cookie was set, even though `Lax` is now the default in Chrome!
