...
original_path: knowledge-inbox/blogs-incoming/2023-06-07_mssql-linked-servers-abusing-adsi-for-password-retrieval.md
original_filename: 2023-06-07_mssql-linked-servers-abusing-adsi-for-password-retrieval.md
...
- mobile-security
language: en
raw_sha256: df9e9975b0ee0289fce0ffe044df92eaefaf1d5b43ff2e02603ac28a467924ae
text_sha256: 4f226caae1c0bab850378f14616db671a48bb80c77a2e6e35d0f76ab5032991e
...
- Original Path: knowledge-inbox/blogs-incoming/2023-06-07_mssql-linked-servers-abusing-adsi-for-password-retrieval.md
- Source Type: markdown
- Detected Topics: sso, access-control, sqli, command-injection, api-security, mobile-security
- Ingested At: 2026-06-28T07:32:21Z
- Redactions Applied: False
- Raw SHA256: `df9e9975b0ee0289fce0ffe044df92eaefaf1d5b43ff2e02603ac28a467924ae`
- Text SHA256: `4f226caae1c0bab850378f14616db671a48bb80c77a2e6e35d0f76ab5032991e`
...
---
title: "MSSQL linked servers: abusing ADSI for password retrieval"
url: "https://www.tarlogic.com/blog/linked-servers-adsi-passwords/"
final_url: "https://www.tarlogic.com/blog/linked-servers-adsi-passwords/"
...
[Home](https://www.tarlogic.com) / [Blog](https://www.tarlogic.com/blog/) / MSSQL linked servers: abusing ADSI for password retrieval

# MSSQL linked servers: abusing ADSI for password retrieval

07 - Jun - 2023 \- Pablo Martínez 
...
After discussing its inner workings, we are presenting a new technique to retrieve cleartext linked login passwords and, in some cases, the password of the current security context. This has proven useful in several of our [Red teaming](https://www.tarlogic.com/red-team-services/) engagements.
...
[![Typical ADSI link usage](data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)](https://www.tarlogic.com/wp-content/uploads/2023/06/adsi_creation.png) Typical ADSI link usage
...
[![Linked login password \(simple bind\)](data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)](https://www.tarlogic.com/wp-content/uploads/2023/06/login_link_user.png) Linked login password (simple bind)
...
[![Windows Authentication \(GSSAPI\)](data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)](https://www.tarlogic.com/wp-content/uploads/2023/06/login_noUser_NTLM.png) Windows Authentication (GSSAPI)
...
[![Current SQL login cleartext password \(simple bind\)](data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)](https://www.tarlogic.com/wp-content/uploads/2023/06/login_noUser_SQL.png) Current SQL login cleartext password (simple bind)
...
[![Login types and associated LDAP authentication](data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)](https://www.tarlogic.com/wp-content/uploads/2023/06/table-1.png) Login types and associated LDAP authentication
...
[![Scenario 1 schema](data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)](https://www.tarlogic.com/wp-content/uploads/2023/06/adsi_schema1.png) Scenario 1 schema
...
[![Scenario 2 schema](data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)](https://www.tarlogic.com/wp-content/uploads/2023/06/adsi_schema2.png) Scenario 2 schema
...
The code in charge of parsing the LDAP messages is borrowed from [this project](https://github.com/vforteli/Flexinets.Ldap.Core). You can find our functional CLR assembly [here](https://github.com/blackarrowsec/redteam-research/tree/master/MSSQL%20linked%20servers%20-%20ADSI).

Share this article

[Facebook](https://www.facebook.com/sharer.php?u=https://www.tarlogic.com/blog/linked-servers-adsi-passwords/) \- [Twitter](https://x.com/share?text=MSSQL linked servers: abusing ADSI for password retrieval&url=https://www.tarlogic.com/blog/linked-servers-adsi-passwords/) \- [Linkedin](https://www.linkedin.com/shareArticle?mini=true&url=https://www.tarlogic.com/blog/linked-servers-adsi-passwords/&title=MSSQL linked servers: abusing ADSI for password retrieval&summary=New technique to gather passwords from MSSQL by abusing linked servers through the ADSI provider)
