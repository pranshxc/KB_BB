...
original_path: knowledge-inbox/blogs-incoming/2024-08-16_spip-preauth-rce-2024-part-1-the-feather.md
original_filename: 2024-08-16_spip-preauth-rce-2024-part-1-the-feather.md
...
- sqli
language: en
raw_sha256: 3b142130dc09fe1e0be8543e5bfafcf2a4683771277b7539b910b5686186269c
text_sha256: 857d5375e522457fabf3a0a4577012bb60d297eaacfaece774b56bd52d3fcd9a
...
- Original Path: knowledge-inbox/blogs-incoming/2024-08-16_spip-preauth-rce-2024-part-1-the-feather.md
- Source Type: markdown
- Detected Topics: command-injection, supply-chain, idor, access-control, xss, sqli
- Ingested At: 2026-06-28T07:32:37Z
- Redactions Applied: False
- Raw SHA256: `3b142130dc09fe1e0be8543e5bfafcf2a4683771277b7539b910b5686186269c`
- Text SHA256: `857d5375e522457fabf3a0a4577012bb60d297eaacfaece774b56bd52d3fcd9a`
...
---
title: "Spip Preauth RCE 2024: Part 1, The Feather"
page_title: "Spip Preauth RCE 2024: Part 1, The Feather • Think
Love
Share"
url: "https://thinkloveshare.com/hacking/spip_preauth_rce_2024_part_1_the_feather/"
final_url: "https://thinkloveshare.com/hacking/spip_preauth_rce_2024_part_1_the_feather/"
...
__Aug 16, 2024 __22 min read __[Translate](https://thinkloveshare-com.translate.goog/?_x_tr_sl=en&_x_tr_tl=fr)  
...
![](release-note-security-headsup.png)
...
![](porte-plume-previsu-reflect.png)
...
![](summer-spip-challenge-tweet.png)
...
Spip embeds templates called `squelettes` which are used to render php code. A markup language specific to SPIP is used to generate this code, and it is in these templates that injection resided a few months ago, resulting in command execution (cf: [icalendar generation](https://thinkloveshare.com/hacking/rce_on_spip_and_root_me_v2/)).
...
![](call_traitement_previsu.png)

Anyway, once done we can see that the first eval cannot be used as we do not control any of its arguments… However the other looks better but seems hard to reach as it required the constant `_PROTEGE_PHP_MODELES` to be defined: ![](going_into_second_eval.png)
...
However this constant is defined in `texte_mini.php`: ![](define_constant.png)
...
[ __ Kong & Konga Exploitation & Hardening ](/hacking/kong-konga-exploitation-and-hardening/) [ Spip Preauth RCE 2024: Part 2, A Big Upload __](/hacking/spip_preauth_rce_2024_part_2_a_big_upload/)
