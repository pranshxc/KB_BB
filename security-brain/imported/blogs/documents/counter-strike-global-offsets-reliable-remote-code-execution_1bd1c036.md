...
original_path: knowledge-inbox/blogs-incoming/2021-05-13_counter-strike-global-offsets-reliable-remote-code-execution.md
original_filename: 2021-05-13_counter-strike-global-offsets-reliable-remote-code-execution.md
...
- api-security
language: en
raw_sha256: 1bd1c0360137d7bf4c38e5a5fb2af5ec613186aaa354b6295a27000d84530c9d
text_sha256: e15e93ae71d4041600d01bfb4950316de10f3cb33c564fdc2aea1b2e115ca300
...
- Original Path: knowledge-inbox/blogs-incoming/2021-05-13_counter-strike-global-offsets-reliable-remote-code-execution.md
- Source Type: markdown
- Detected Topics: command-injection, automation-abuse, information-disclosure, api-security
- Ingested At: 2026-06-28T07:32:06Z
- Redactions Applied: False
- Raw SHA256: `1bd1c0360137d7bf4c38e5a5fb2af5ec613186aaa354b6295a27000d84530c9d`
- Text SHA256: `e15e93ae71d4041600d01bfb4950316de10f3cb33c564fdc2aea1b2e115ca300`
...
---
title: "Counter-Strike Global Offsets: reliable remote code execution"
page_title: "Counter-Strike Global Offsets: reliable remote code execution | secret club"
url: "https://secret.club/2021/05/13/source-engine-rce-join.html"
final_url: "https://secret.club/2021/05/13/source-engine-rce-join.html"
...
![main authors image](/assets/author_img/brymko.jpg) [brymko](/author/brymko), [dezk](/author/dezk), [Simon Scannell](/author/simon-scannell)
...
![](/assets/csgo_rce/serverlist.png)
...
More importantly, this custom UDP-based protocol carries `Protobuf` serialized payloads. [Protobuf](https://developers.google.com/protocol-buffers) is a technology developed by Google which allows defining messages and provides an API for serializing and deserializing those messages.
...
We found this message definition by doing a Google search after having discovered CS:GO utilizes Protobuf. We came across the [SteamDatabase](https://github.com/SteamDatabase/Protobufs/) GitHub repository containing a list of Protobuf message definitions.
...
![](/assets/csgo_rce/csgo_proxy.gif)
...
To further enable customization of the game, the server and client exchange `ConVar`s, which are essentially configuration options.
...
The Windows heap is kind of nondeteministic. That is, a `malloc -> free -> malloc` combo will not yield the same block. Thankfully, Saar Amaar published his [great research](https://github.com/saaramar/Deterministic_LFH) about the Windows heap, which we consulted to get a better understanding about our exploit context.
...
Tagged[ guest](/tags#guest),[ source-engine](/tags#source-engine),[ binary-exploitation](/tags#binary-exploitation),[ pwn](/tags#pwn) [PREVIOUSCVE-2021-30481: Source engine remote code execution via game invites ](/2021/04/20/source-engine-rce-invite.html) [NEXTPreventing memory inspection on Windows ](/2021/05/23/big-memory.html)
