...
original_path: knowledge-inbox/blogs-incoming/2022-08-12_researching-xiaomis-tee-to-get-to-chinese-money.md
original_filename: 2022-08-12_researching-xiaomis-tee-to-get-to-chinese-money.md
...
- xss
language: en
raw_sha256: 44f41e2aea60d4fc4691858ab19212ce3a5700be5cc7230387ae42df9d002dd3
text_sha256: edbc2e40bc6a9924eb7064a1eda40787e34e676ab25271d4ae6a8fd64ab777c4
...
- Original Path: knowledge-inbox/blogs-incoming/2022-08-12_researching-xiaomis-tee-to-get-to-chinese-money.md
- Source Type: markdown
- Detected Topics: cloud-security, supply-chain, mobile-security, sso, access-control, xss
- Ingested At: 2026-06-28T07:32:13Z
- Redactions Applied: True
- Raw SHA256: `44f41e2aea60d4fc4691858ab19212ce3a5700be5cc7230387ae42df9d002dd3`
- Text SHA256: `edbc2e40bc6a9924eb7064a1eda40787e34e676ab25271d4ae6a8fd64ab777c4`
...
---
title: "Researching Xiaomi’s TEE to get to Chinese money"
page_title: "Researching Xiaomi’s TEE to get to Chinese money - Check Point Research"
url: "https://research.checkpoint.com/2022/researching-xiaomis-tee/"
final_url: "https://research.checkpoint.com/2022/researching-xiaomis-tee/"
...
![](https://research.checkpoint.com/wp-content/uploads/2022/08/Social_1200x628-copy.jpg)

# Researching Xiaomi’s TEE to get to Chinese money

August 12, 2022 

[](https://www.linkedin.com/shareArticle?mini=true&url=https://research.checkpoint.com/2022/researching-xiaomis-tee/ -  https://research.checkpoint.com/?p=26351;source=LinkedIn "Share on LinkedIn!") [](http://www.facebook.com/sharer.php?u=https://research.checkpoint.com/2022/researching-xiaomis-tee/ - https://research.checkpoint.com/?p=26351  "Share on Facebook!") [](http://twitter.com/home/?status=Researching Xiaomi’s TEE to get to Chinese money - https://research.checkpoint.com/?p=26351 via @kenmata  "Tweet this!")
...
Xiaomi devices that are based on Qualcomm chips use QSEE trusted OS. MediaTek-based devices use Beanpod TEE or Mitee. In both cases, Xiaomi can embed and sign their own trusted applications. In our research, we focus on trusted apps of MediaTek-powered devices. The test device is the Xiaomi Redmi Note 9T 5G with MIUI Global [12.5.6.0](http://12.5.6.0/ "http://12.5.6.0") OS. This device uses Beanpod TEE.
...
![](//research.checkpoint.com/wp-content/uploads/2022/08/1.png)
...
Xiaomi follows the GlobalPlatform TEE [_Client API_](https://globalplatform.org/wp-content/uploads/2010/07/TEE_Client_API_Specification-V1.0.pdf) Specification that defines the communication API between a client and the TEE.
...
![](//research.checkpoint.com/wp-content/uploads/2022/08/2.png)
...
![](//research.checkpoint.com/wp-content/uploads/2022/08/3.png)
...
WeChat Pay and Alipay are the two largest players in the Chinese digital payment industry. Together, they account for about 95% of the Chinese mobile payments market. Each of these platforms has over [_1 billion_](https://www.statista.com/statistics/1271130/mobile-wallet-user-forecast-in-china) users. WeChat Pay is based on the Tencent soter.
...
![](//research.checkpoint.com/wp-content/uploads/2022/08/4.png)
...
![](//research.checkpoint.com/wp-content/uploads/2022/08/5.png)
...
![](//research.checkpoint.com/wp-content/uploads/2022/08/6.png)
...
If we hold the target device in our hands, it is enough to send the `HAS_AUTH_KEY` (0x100b) command to the app and specify the address we are interested in as the second parameter to read the memory content in the Android kernel log.![](//research.checkpoint.com/wp-content/uploads/2022/08/9.png)
...
![](//research.checkpoint.com/wp-content/uploads/2022/08/7.png)

**Figure 4:** Tencent soter implementation.

The `com.tencent.soter.soterserver` system app exports (shares for the public access) the `SoterService` service, which provides the API to manage the soter keys. The service binds the `[[email protected]](/cdn-cgi/l/email-protection)` system service to communicate with the `soter` trusted app.
...
![](//research.checkpoint.com/wp-content/uploads/2022/08/8.png)
