...
original_path: knowledge-inbox/blogs-incoming/2023-12-22_doubletrouble.md
original_filename: 2023-12-22_doubletrouble.md
title: DoubleTrouble
category: documents
detected_topics:
- command-injection
...
- otp
language: en
raw_sha256: e101445f960e663775aadc3d63d8afcab7b4cad0f362a7f6d4a037ec5a8d6d80
text_sha256: 7e9a7d06a87e00555f86c338085e07c27d5433cbcac236c8a52fe6162a1f7d0e
...
- Original Path: knowledge-inbox/blogs-incoming/2023-12-22_doubletrouble.md
- Source Type: markdown
- Detected Topics: command-injection, automation-abuse, cloud-security, supply-chain, otp
- Ingested At: 2026-06-28T07:32:29Z
- Redactions Applied: True
- Raw SHA256: `e101445f960e663775aadc3d63d8afcab7b4cad0f362a7f6d4a037ec5a8d6d80`
- Text SHA256: `7e9a7d06a87e00555f86c338085e07c27d5433cbcac236c8a52fe6162a1f7d0e`
...
---
title: "DoubleTrouble"
page_title: "GitHub - TecR0c/DoubleTrouble: This repository offers insights and a proof-of-concept tool to exploit two significant deserialization vulnerabilities in Inductive Automation's Ignition software. · GitHub"
url: "https://github.com/TecR0c/DoubleTrouble"
final_url: "https://github.com/TecR0c/DoubleTrouble"
...
The vulnerabilities require the gateway network to be configured, which is a common configuration: [Gateway Network](https://docs.inductiveautomation.com/display/DOC80/Gateway+Network). This was same vector as used in [Pwn2Own Miami 2020](https://www.zerodayinitiative.com/advisories/ZDI-20-687/), so it appears that vendors don't learn.

### SSL Considerations on Gateway

SSL needs to be disabled in the network gateway _unless_ HTTPS is enabled on the server, in which case the attacker can set the SSL flag in the exploit to true to have the exploit work over HTTPS.

[![non ssl](/TecR0c/DoubleTrouble/raw/main/pics/non-ssl-requirement.png)](/TecR0c/DoubleTrouble/blob/main/pics/non-ssl-requirement.png)
...
We can set the codec name to two different MessageCodec classes:
  ...
  protected static class ***REDACTED-SUSPECT-TOKEN***  implements MessageCodec
  {
...
[![Attacking the target using the ParameterVersionJavaSerializationCodec vulnerability](/TecR0c/DoubleTrouble/raw/main/pics/ParameterVersionJavaSerializationCodec.gif)](/TecR0c/DoubleTrouble/blob/main/pics/ParameterVersionJavaSerializationCodec.gif)

### Specifying the outgoing directly (for an internet routable attack)

[![Attacking the target using the JavaSerializationCodec vulnerability](/TecR0c/DoubleTrouble/raw/main/pics/JavaSerializationCodec.gif)](/TecR0c/DoubleTrouble/blob/main/pics/JavaSerializationCodec.gif)
