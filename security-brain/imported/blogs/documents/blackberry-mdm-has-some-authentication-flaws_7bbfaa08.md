...
original_path: knowledge-inbox/blogs-incoming/2024-04-22_blackberry-mdm-has-some-authentication-flaws.md
original_filename: 2024-04-22_blackberry-mdm-has-some-authentication-flaws.md
...
- command-injection
language: en
raw_sha256: 7bbfaa0896167a2fb352199042a60aff84556105cbcbb14eaddacd229895cc5e
text_sha256: f8a99616df050cc830dc0c72fa26c203fddaa45ffd3cbaa1c86c09301c4fa059
...
- Original Path: knowledge-inbox/blogs-incoming/2024-04-22_blackberry-mdm-has-some-authentication-flaws.md
- Source Type: markdown
- Detected Topics: mobile-security, api-security, supply-chain, sso, idor, command-injection
- Ingested At: 2026-06-28T07:32:33Z
- Redactions Applied: False
- Raw SHA256: `7bbfaa0896167a2fb352199042a60aff84556105cbcbb14eaddacd229895cc5e`
- Text SHA256: `f8a99616df050cc830dc0c72fa26c203fddaa45ffd3cbaa1c86c09301c4fa059`
...
---
title: "BlackBerry MDM Has Some Authentication Flaws"
page_title: "BlackBerry MDM Has Some Authentication Flaws | Into the Abyss"
url: "https://emptynebuli.github.io/tooling/2024/04/22/blackberryMDM.html"
final_url: "https://emptynebuli.github.io/tooling/2024/04/22/blackberryMDM.html"
...
[![Figure 1: BlackBerry Source-Code Masking](/assets/images/blackberry_img1.png)](/assets/images/blackberry_img1.png "Figure 1: BlackBerry Source-Code Masking") **Figure 1: BlackBerry Source-Code Masking**
...
I will not be covering the use and configuration of Frida in this blog article and encourage the reader to review the content available through the referenced link. There are several online scripts that can assist with disabling certificate pinning in the Android system.
...
[![Figure 2: BlackBerry MDM Discovery - X-AuthToken](/assets/images/blackberry_img2.png)](/assets/images/blackberry_img2.png "Figure 2: BlackBerry MDM Discovery - X-AuthToken") **Figure 2: BlackBerry MDM Discovery - X-AuthToken**

The `X-AuthToken` was used to validate the request and without this value, a 401 failure was returned from the API:

[![Figure 3: BlackBerry MDM Discovery - Failed Request](/assets/images/blackberry_img3.png)](/assets/images/blackberry_img3.png "Figure 3: BlackBerry MDM Discovery - Failed Request") **Figure 3: BlackBerry MDM Discovery - Failed Request**

Interestingly enough, these values did seem to allow for replay attacks - which is always a useful tidy of information ;P..

[![Figure 4: BlackBerry MDM Discovery - Replay #1](/assets/images/blackberry_img4.png)](/assets/images/blackberry_img4.png "Figure 4: BlackBerry MDM Discovery - Replay #1") **Figure 4: BlackBerry MDM Discovery - Replay #1** [![Figure 5: BlackBerry MDM Discovery - Replay #2](/assets/images/blackberry_img5.png)](/assets/images/blackberry_img5.png "Figure 5: BlackBerry MDM Discovery - Replay #2") **Figure 5: BlackBerry MDM Discovery - Replay #2**
...
[![Figure 6: BlackBerry MDM - Hardcoded Keys](/assets/images/blackberry_img6.png)](/assets/images/blackberry_img6.png "Figure 6: BlackBerry MDM - Hardcoded Keys") **Figure 6: BlackBerry MDM - Hardcoded Keys**
...
[![Figure 8: BlackBerry MDM Auth Request](/assets/images/blackberry_img7.png)](/assets/images/blackberry_img7.png "Figure 8: BlackBerry MDM Auth Request") **Figure 8: BlackBerry MDM Auth Request**

Based on the server response code - this will either pass or fail. FYI, during this research I only received failed authentication attempts. Although these failed authentication attempts did not recieve an _HTTP 200_ response - they did indicate _valid_ vs _invalid_ username values.

[![Figure 9: BlackBerry MDM Auth Request - Failure Response](/assets/images/blackberry_img8.png)](/assets/images/blackberry_img8.png "Figure 9: BlackBerry MDM Auth Request - Failure Response") **Figure 9: BlackBerry MDM Auth Request - Failure Response**
...
[![Figure 10: com.blackberry.emalib.bdmitransport.hooodor.H0dooor - spekexp.so Loaded](/assets/images/blackberry_img9.png)](/assets/images/blackberry_img9.png "Figure 10: com.blackberry.emalib.bdmitransport.hooodor.H0dooor - spekexp.so Loaded") **Figure 10: com.blackberry.emalib.bdmitransport.hooodor.H0dooor - spekexp.so Loaded**

The method call to `new Enroll` creates an enrollment objects via the method `EnrollmentInterface.enrollment_create`. This method call would return an _INT_ value represeting an _ID_ for the current enrollment request:

[![Figure 11: com.blackberry.enrollment - Enroll Initialization](/assets/images/blackberry_img10.png)](/assets/images/blackberry_img10.png "Figure 11: com.blackberry.enrollment - Enroll Initialization") **Figure 11: com.blackberry.enrollment - Enroll Initialization** [![Figure 12: com.blackberry.enrollment - enrollment_create Method Call](/assets/images/blackberry_img11.png)](/assets/images/blackberry_img11.png "Figure 12: com.blackberry.enrollment - enrollment_create Method Call") **Figure 12: com.blackberry.enrollment - enrollment_create Method Call**

Based on references to `KEY_TYPE_RSA` in the method call for `new Enroll` (listed in _Figure 10_) there was an assumption this value was encrypted with some form of AES. AES is a pretty common encryption algorithm for web/mobile applications - so I felt this was a safe assumption. As there were no direct references to how encryption was performed, outside of the `libspekexp.so` native library, this is where I presumed this process to take place.
...
**Figure 13: Frida Script - Native Library Enumeration** [![Figure 14: libspekexp.so Exports](/assets/images/blackberry_img12.png)](/assets/images/blackberry_img12.png "Figure 14: libspekexp.so Exports") **Figure 14: libspekexp.so Exports**
...
**Figure 15: Frida Script - Native Library Hooking**
...
[![Figure 16: libsepekexp.so - speke_aes_encrypt Function Constructor](/assets/images/blackberry_img13.png)](/assets/images/blackberry_img13.png "Figure 16: libsepekexp.so - speke_aes_encrypt Function Constructor") **Figure 16: libsepekexp.so - speke_aes_encrypt Function Constructor**
...
[![Figure 17: libsepekexp.so - Hardcoded AES-256 Encryption Key and IV](/assets/images/blackberry_img14.png)](/assets/images/blackberry_img14.png "Figure 17: libsepekexp.so - Hardcoded AES-256 Encryption Key and IV") **Figure 17: libsepekexp.so - Hardcoded AES-256 Encryption Key and IV**
...
**Figure 18: Frida Script - Encryption Key and IV Recovery**
...
[![Figure 19: ORG BlackBerry MDM Auth Request](/assets/images/blackberry_img15.png)](/assets/images/blackberry_img15.png "Figure 19: ORG BlackBerry MDM Auth Request") **Figure 19: ORG BlackBerry MDM Auth Request**

Decoding the Base64 hashed bytecode revealed the 16-byte `IV`, followed by the encrypted username:

[![Figure 20: BlackBerry MDM - Decoded Username Submission](/assets/images/blackberry_img16.png)](/assets/images/blackberry_img16.png "Figure 20: BlackBerry MDM - Decoded Username Submission") **Figure 20: BlackBerry MDM - Decoded Username Submission**
...
[![Figure 21: BlackBerry MDM - User Enumeration?](/assets/images/blackberry_img17.png)](/assets/images/blackberry_img17.png "Figure 21: BlackBerry MDM - User Enumeration?") **Figure 21: BlackBerry MDM - User Enumeration?**

This information was also reported to BlackBerry, receiving the following response:

**_“The EC-SPEKE handshake is encrypted in transit with TLS and the server certificate is validated against the platform root certificate authority (CA) store. Assuming the platform and application have integrity (e.g. not rooted or hooked), this means the only parties who can decrypt the obfuscated username are the service operators (i.e. BlackBerry employees and Enterprise customers for their own users). We do not support multi-factor enrollment, the key authentication factor for all forms of UEM device enrollment is a limited-lifetime password or token. Note that in the outlined attack, the user ID alone is not sufficient to complete the key exchange and the potential attacker would still need to obtain the activation password.”_**

One interesting item of note in this response is BlackBerry identifies the enrollment function does not support _multi-factor_?! Indicating like AirWatch and MobileIron, BlackBerry too is vulnerable to SFA within the MDM application. Just some food for thought.
...
[![Figure 22: ECC Key Exchange](/assets/images/blackberry_img18.png)](/assets/images/blackberry_img18.png "Figure 22: ECC Key Exchange") **Figure 22: ECC Key Exchange**
...
[](/tooling/2024/04/22/blackberryMDM.html)
