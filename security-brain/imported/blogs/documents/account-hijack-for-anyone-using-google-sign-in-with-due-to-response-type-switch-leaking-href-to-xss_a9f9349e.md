...
original_path: knowledge-inbox/blogs-incoming/2023-09-10_account-hijack-for-anyone-using-google-sign-in-with-due-to-response-type-switch-.md
original_filename: 2023-09-10_account-hijack-for-anyone-using-google-sign-in-with-due-to-response-type-switch-.md
title: Account hijack for anyone using Google sign-in with , due to response-type
  switch + leaking href to XSS on login.redacted.com
category: documents
detected_topics:
- oauth
- sso
...
- command-injection
language: en
raw_sha256: a9f9349e8abc3132a7d42df592a75e61333ec18a2204de8379beceeb3710fd89
text_sha256: 3600e92a9b0d8f56100821d2d77258454e84a8914c82d3bf7a3e2af787cd2a07
...
- Original Path: knowledge-inbox/blogs-incoming/2023-09-10_account-hijack-for-anyone-using-google-sign-in-with-due-to-response-type-switch-.md
- Source Type: markdown
- Detected Topics: oauth, sso, jwt, access-control, xss, command-injection
- Ingested At: 2026-06-28T07:32:26Z
- Redactions Applied: False
- Raw SHA256: `a9f9349e8abc3132a7d42df592a75e61333ec18a2204de8379beceeb3710fd89`
- Text SHA256: `3600e92a9b0d8f56100821d2d77258454e84a8914c82d3bf7a3e2af787cd2a07`
...
page_title: "xss-writeups/oauth-dance.md at main · Sudistark/xss-writeups · GitHub"
url: "https://github.com/Sudistark/xss-writeups/blob/main/oauth-dance.md"
final_url: "https://github.com/Sudistark/xss-writeups/blob/main/oauth-dance.md"
...
My friend @testingforbugs reached to out to me , he had a xss in login.redacted.com and wanted to escalate the xss bug impact, cookies were marked as httponly and the main functionalities of the application were on [www.redacted.com](http://www.redacted.com) so the escalation wasn't going to be easy here.
...
<https://hackerone.com/reports/1567186> <https://gitlab.com/gitlab-org/gitlab/-/issues/362394>
...
Now all we need is a way to steal the hash fragment. As our xss is in the same domain, I can easily read it. All I need is to make some relation between the error page containing code in hash and the xss page.
...
[https://login.redacted.com/identity/sso/ui/AuthorizationError?ErrorCode=No_Oauth_State&ErrorDescription=State+was+not+sent+back&ProviderId=redacted#state=CAAAAY&code=4/0Ad...&id_token=eyJh](https://login.redacted.com/identity/sso/ui/AuthorizationError?ErrorCode=No_Oauth_State&ErrorDescription=State+was+not+sent+back&ProviderId=redacted#state=CAAAAY&code=4/0Ad...&id_token=eyJh)..................
...
[![BurpSuiteCommunity_xLyg501nml](https://private-user-images.githubusercontent.com/31372554/266822243-c80c6611-6339-478a-8a2f-8bb2cb4d7d0f.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..H-nXrIcdBwSSZFuUm6yo1eooibm2jXB44UqKh5qMstM)](https://private-user-images.githubusercontent.com/31372554/266822243-c80c6611-6339-478a-8a2f-8bb2cb4d7d0f.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..H-nXrIcdBwSSZFuUm6yo1eooibm2jXB44UqKh5qMstM)
...
Then we send the cookie to our logging server so that we can use it later. On line [2] we modify the `response_type` parameter value to `code,id_token`.
...
This is the xss payload which we will be using , basically it alerts the `window.opener.document.location.hash` value after 9sec.
