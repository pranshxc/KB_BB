...
original_path: knowledge-inbox/blogs-incoming/2024-06-07_zoom-session-takeover-cookie-tossing-payloads-oauth-dirty-dancing-browser-permis.md
original_filename: 2024-06-07_zoom-session-takeover-cookie-tossing-payloads-oauth-dirty-dancing-browser-permis.md
title: Zoom Session Takeover - Cookie Tossing Payloads, OAuth Dirty Dancing, Browser
  Permissions Hijacking, and WAF abuse
category: documents
detected_topics:
- oauth
- xss
...
- mfa
language: en
raw_sha256: 25eed1af2e4cc320d1e9b133d6832ecc2f71ea37043dcfaff45eaff59146ec67
text_sha256: 30ab1c6d3c67e0e8f0743d182b3792e7e6a5f876691d0ed2a3087d114506f498
...
- Original Path: knowledge-inbox/blogs-incoming/2024-06-07_zoom-session-takeover-cookie-tossing-payloads-oauth-dirty-dancing-browser-permis.md
- Source Type: markdown
- Detected Topics: oauth, xss, access-control, command-injection, password-reset, mfa
- Ingested At: 2026-06-28T07:32:34Z
- Redactions Applied: True
- Raw SHA256: `25eed1af2e4cc320d1e9b133d6832ecc2f71ea37043dcfaff45eaff59146ec67`
- Text SHA256: `30ab1c6d3c67e0e8f0743d182b3792e7e6a5f876691d0ed2a3087d114506f498`
...
page_title: "Zoom Session Takeover - Cookie Tossing Payloads, OAuth Dirty Dancing, Browser Permissions Hijacking, and WAF abuse | Harel Security Research"
url: "https://nokline.github.io/bugbounty/2024/06/07/Zoom-ATO.html"
final_url: "https://nokline.github.io/bugbounty/2024/06/07/Zoom-ATO.html"
...
![](/images/zoom_alert.png)

  

Because Zoom takes their security seriously, there was a CSP policy on almost every page, meaning almost _every_ page was vulnerable to this cookie XSS. Not only that, but since most zoom subdomains are actually clones of the main `zoom.us` domain, we actually had a cookie XSS on almost every page and on almost _every_ subdomain on zoom. Quite a lot of “potential energy” here, however nothing actually exploitable yet.
...
In the response header `Set-Cookie` you can see there is indeed some cookie parameter which seems to be related to OAuth somehow
  ...
  zm_OAuth_back_params=***REDACTED-SUSPECT-TOKEN***  _zm_o2state=FaILMc3BTNCgYeNKg5LzMA
...
This resulted in an error: _Nonce required for response_type id_token._

  

![](/images/auth_error.png)
...
[](/bugbounty/2024/06/07/Zoom-ATO.html)
