...
original_path: knowledge-inbox/blogs-incoming/2022-09-23_alternative-link_2.md
original_filename: 2022-09-23_alternative-link_2.md
...
- cloud-security
language: en
raw_sha256: 0c78bb0b04918d030eda58adc0e008f5525a6811bf37446b4c5ee8cf9fa6de11
text_sha256: 906a00836f566fe771c945fe8f359d3187064c63d866511e5002aa06d6fe93a6
...
- Original Path: knowledge-inbox/blogs-incoming/2022-09-23_alternative-link_2.md
- Source Type: markdown
- Detected Topics: command-injection, automation-abuse, ssrf, path-traversal, api-security, cloud-security
- Ingested At: 2026-06-28T07:32:14Z
- Redactions Applied: False
- Raw SHA256: `0c78bb0b04918d030eda58adc0e008f5525a6811bf37446b4c5ee8cf9fa6de11`
- Text SHA256: `906a00836f566fe771c945fe8f359d3187064c63d866511e5002aa06d6fe93a6`
...
---
title: "Alternative link"
page_title: "Pre-Auth Remote Code Execution — Web Page Test | by Loukajc | ManoMano Tech team | Medium"
url: "https://medium.com/manomano-tech/pre-auth-remote-code-execution-web-page-test-9937d78d2f41"
...
Hi there! Are you a regular Mano-Tech reader?

If so, you’re already somehow familiar with today’s blog post: Abusing WebPageTest for fun & security purpose!

I wasn’t there a few months back when 
Roni CARTA
 broke it the first time. Back then, we had a strong dependency on WebPageTest so the engineering staff could not get rid of it that easily. Alternatives were considered and worked on. In the meantime, WPT has been confined, updated, and hardened on our side to some extent.

I still thought this software was exposing us too too many risks, and by the time I joined, alternatives were almost ready for prod! The only thing we still needed was a good reason to make our move, therefore I came with a different approach to break it again!

Press enter or click to view image in full size
Before we start…

This talk was given at the @DefconParis meetup on the 19th of September 2022, if you rather like watching than reading, here it is! 👇

Press enter or click to view image in full size
Me presenting at the DefconParis meetup
Enjoy watching!
0. Context for this research

You read it, I (Louka J.C. / Laluka) happily joined the ManoMano Security-Team a few months ago, and so far, so gooood!
...
To do so, I spent time on the documentation, and went later on for a more tech-savvy approach!
...
One week later, Web Page Test was gone because another pre-auth SSRF was found in under 15 minutes.

But as the engineering crew trusted us on this move that required time, thinking, and work, we really wanted them to know that they trusted us for good reasons. So during my next R&D week (1 out of 4, so yup, this was my free time), I spent a few more days to turn this SSRF into a pre-auth RCE, including ways to exploit both WPT master and workers.
...
Sadly, they forgot (at least) one sink that let the exploitation go further. It would be nice to have a way to enforce such behaviour on all filesystem related functions, or to only allow schemes by whitelisting… :)

Ever heard of Snuffleupagus? If not, this should definitely be your next reading! Well.. After this one of course. :]

Get Loukajc’s stories in your inbox
...
There are a few other pre-auth file writes present on the app, among those, one allows us to write arbitrary controlled content fetched by an SSRF to the filesystem, and the path is a SHA of its content split every four char. So it’s a file write, to a predictable location.
...
This is also why I’m deeply thankful to ManoMano which allowed me (as a company and as my manager’s choice, @BaskFr) to work part time (75%). This means that I’ll work for (with ❤️) them for three weeks, and use the last one for personal research, helping friends out, and hmm… Sleep? Sleep.
...
As always, feedbacks are more than welcome, and…
We are hiring in France and Spain! 🥳🎉
