...
original_path: knowledge-inbox/blogs-incoming/2020-06-10_guest-blog-from-file-upload-to-rce.md
original_filename: 2020-06-10_guest-blog-from-file-upload-to-rce.md
...
- automation-abuse
language: en
raw_sha256: d4343cd97ecbe152b7db9945a73784fd09d317368d693925afbec4a6622ce70f
text_sha256: 960db34751fe456152146824b30b5349f08c7243be40736128760a51607d31fc
...
- Original Path: knowledge-inbox/blogs-incoming/2020-06-10_guest-blog-from-file-upload-to-rce.md
- Source Type: markdown
- Detected Topics: command-injection, sso, sqli, file-upload, mfa, automation-abuse
- Ingested At: 2026-06-28T07:32:02Z
- Redactions Applied: False
- Raw SHA256: `d4343cd97ecbe152b7db9945a73784fd09d317368d693925afbec4a6622ce70f`
- Text SHA256: `960db34751fe456152146824b30b5349f08c7243be40736128760a51607d31fc`
...
---
title: "Guest Blog: From File Upload to RCE"
page_title: "Guest Blog: From File Upload to RCE | Synack"
url: "https://www.synack.com/blog/guest-blog-from-file-upload-to-rce/"
final_url: "https://www.synack.com/exploits-explained/guest-blog-from-file-upload-to-rce/"
...
![blog-digitalLock2020](https://cdn-ilehafm.nitrocdn.com/CEIcVhvPIRwjlbZfWoPvwdyDLoTdsmEr/assets/images/optimized/rev-ce9e3ba/www.synack.com/wp-content/themes/synack/webroot/images/blazy.png)

#  Guest Blog: From File Upload to RCE 

0% read 

(Author’s Note: This vulnerability was found during testing on [Synack](https://www.synack.com/). I have anonymized, altered, or removed all detail about the customer to keep this information confidential in line with Synack policies.)
...
I started with a .GIF file. To make the identification of changes easier I picked up an [image](https://lwierzbicki.github.io/assets/from-file-upload-to-rce-test.gif) with one color (black) and no animation. According to [KISS principle](https://en.wikipedia.org/wiki/KISS_principle).
...
![Testfile](https://cdn-ilehafm.nitrocdn.com/CEIcVhvPIRwjlbZfWoPvwdyDLoTdsmEr/assets/images/optimized/rev-ce9e3ba/lwierzbicki.github.io/assets/from-file-upload-to-rce-testfile.png)

I injected the code by modifying hex values in Burp and carved my payload into the GIF image.

![Carving first payload](https://cdn-ilehafm.nitrocdn.com/CEIcVhvPIRwjlbZfWoPvwdyDLoTdsmEr/assets/images/optimized/rev-ce9e3ba/lwierzbicki.github.io/assets/from-file-upload-to-rce-carving.png)

Another payload is:

![Carving second payload](https://cdn-ilehafm.nitrocdn.com/CEIcVhvPIRwjlbZfWoPvwdyDLoTdsmEr/assets/images/optimized/rev-ce9e3ba/lwierzbicki.github.io/assets/from-file-upload-to-rce-carving2.png)
...
![phpinfo](https://cdn-ilehafm.nitrocdn.com/CEIcVhvPIRwjlbZfWoPvwdyDLoTdsmEr/assets/images/optimized/rev-ce9e3ba/lwierzbicki.github.io/assets/from-file-upload-to-rce-phpinfo.png)

-Lukasz Wierzbicki

(Originally published at: [Łukasz Wierzbicki: From File Upload to RCE](https://lwierzbicki.github.io/2020/06/10/from-file-upload-to-rce.html), reprinted with slight modifications with permission.)
